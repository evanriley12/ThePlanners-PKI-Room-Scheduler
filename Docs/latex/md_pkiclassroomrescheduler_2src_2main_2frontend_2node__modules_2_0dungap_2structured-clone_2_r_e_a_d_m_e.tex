\chapter{structured\+Clone polyfill}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dungap_2structured-clone_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dungap_2structured-clone_2_r_e_a_d_m_e}\index{structuredClone polyfill@{structuredClone polyfill}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dungap_2structured-clone_2_r_e_a_d_m_e_autotoc_md4356}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dungap_2structured-clone_2_r_e_a_d_m_e_autotoc_md4356}%
...
Serialized values can be safely stringified as {\itshape JSON} too, and deserialization resurrect all values, even recursive, or more complex than what {\itshape JSON} allows.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dungap_2structured-clone_2_r_e_a_d_m_e_autotoc_md4357}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dungap_2structured-clone_2_r_e_a_d_m_e_autotoc_md4357}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dungap_2structured-clone_2_r_e_a_d_m_e_autotoc_md4358}{}\doxysubsubsection{\texorpdfstring{Global Polyfill}{Global Polyfill}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dungap_2structured-clone_2_r_e_a_d_m_e_autotoc_md4358}
...
{\bfseries{Note}}\+: Do not attach this module\textquotesingle{}s default export directly to the global scope, whithout a conditional guard to detect a native implementation. In environments where there is a native global implementation of {\ttfamily structured\+Clone()} already, assignment to the global object will result in an infinite loop when {\ttfamily global\+This.\+structured\+Clone()} is called. See the example above for a safe way to provide the polyfill globally in your project.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dungap_2structured-clone_2_r_e_a_d_m_e_autotoc_md4359}{}\doxysubsection{\texorpdfstring{Extra Features}{Extra Features}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dungap_2structured-clone_2_r_e_a_d_m_e_autotoc_md4359}
...
The behavior is the same found in {\itshape JSON} when it comes to {\itshape Array}, so that unsupported values will result as {\ttfamily null} placeholders instead.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dungap_2structured-clone_2_r_e_a_d_m_e_autotoc_md4360}{}\doxysubsubsection{\texorpdfstring{to\+JSON}{to\+JSON}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dungap_2structured-clone_2_r_e_a_d_m_e_autotoc_md4360}
