...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2data-urls_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2data-urls_2_r_e_a_d_m_e}\index{Parse $<$tt$>$data:$<$/tt$>$ URLs@{Parse $<$tt$>$data:$<$/tt$>$ URLs}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2data-urls_2_r_e_a_d_m_e_autotoc_md8239}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2data-urls_2_r_e_a_d_m_e_autotoc_md8239}%
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2data-urls_2_r_e_a_d_m_e_autotoc_md8240}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2data-urls_2_r_e_a_d_m_e_autotoc_md8240}
...
As shown in the examples above, both of these have useful {\ttfamily to\+String()} methods for manipulating them as string values. However…\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2data-urls_2_r_e_a_d_m_e_autotoc_md8241}{}\doxysubsection{\texorpdfstring{A word of caution on string decoding}{A word of caution on string decoding}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2data-urls_2_r_e_a_d_m_e_autotoc_md8241}
...
In summary, only use {\ttfamily data\+URL.\+body.\+to\+String()} when you are very certain your data is inside the ASCII range (i.\+e. code points within the range U+0000 to U+007F).\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2data-urls_2_r_e_a_d_m_e_autotoc_md8242}{}\doxysubsection{\texorpdfstring{Advanced functionality\+: parsing from a URL record}{Advanced functionality\+: parsing from a URL record}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2data-urls_2_r_e_a_d_m_e_autotoc_md8242}
