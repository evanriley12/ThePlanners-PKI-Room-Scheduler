...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2require-hook}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2require-hook}\index{Require setup and teardown code to be within a hook ($<$tt$>$require-\/hook$<$/tt$>$)@{Require setup and teardown code to be within a hook ($<$tt$>$require-\/hook$<$/tt$>$)}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2require-hook_autotoc_md10482}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2require-hook_autotoc_md10482}%
...
Because Jest executes all {\ttfamily describe} handlers in a test file {\itshape before} it executes any of the actual tests, it\textquotesingle{}s important to ensure setup and teardown work is done inside {\ttfamily before\texorpdfstring{$\ast$}{*}} and {\ttfamily after\texorpdfstring{$\ast$}{*}} handlers respectively, rather than inside the {\ttfamily describe} blocks.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2require-hook_autotoc_md10483}{}\doxysection{\texorpdfstring{Rule details}{Rule details}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2require-hook_autotoc_md10483}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2require-hook_autotoc_md10484}{}\doxysection{\texorpdfstring{Options}{Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2require-hook_autotoc_md10484}
