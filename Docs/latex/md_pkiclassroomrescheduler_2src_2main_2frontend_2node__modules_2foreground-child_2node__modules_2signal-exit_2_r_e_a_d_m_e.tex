\chapter{signal-\/exit}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2node__modules_2signal-exit_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2node__modules_2signal-exit_2_r_e_a_d_m_e}\index{signal-\/exit@{signal-\/exit}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2node__modules_2signal-exit_2_r_e_a_d_m_e_autotoc_md12609}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2node__modules_2signal-exit_2_r_e_a_d_m_e_autotoc_md12609}%
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2node__modules_2signal-exit_2_r_e_a_d_m_e_autotoc_md12610}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2node__modules_2signal-exit_2_r_e_a_d_m_e_autotoc_md12610}
...
If the global {\ttfamily process} object is not suitable for this purpose (ie, it\textquotesingle{}s unset, or doesn\textquotesingle{}t have an {\ttfamily emit} method, etc.) then the {\ttfamily on\+Exit} function is a no-\/op that returns a no-\/op {\ttfamily remove} method.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2node__modules_2signal-exit_2_r_e_a_d_m_e_autotoc_md12611}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2node__modules_2signal-exit_2_r_e_a_d_m_e_autotoc_md12611}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2node__modules_2signal-exit_2_r_e_a_d_m_e_autotoc_md12612}{}\doxysubsection{\texorpdfstring{Capturing Signal Exits}{Capturing Signal Exits}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2node__modules_2signal-exit_2_r_e_a_d_m_e_autotoc_md12612}
...
Note that numeric code exits may indicate that the process is already committed to exiting, for example due to a fatal exception or unhandled promise rejection, and so there is no way to prevent it safely.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2node__modules_2signal-exit_2_r_e_a_d_m_e_autotoc_md12613}{}\doxysubsection{\texorpdfstring{Browser Fallback}{Browser Fallback}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2node__modules_2signal-exit_2_r_e_a_d_m_e_autotoc_md12613}
