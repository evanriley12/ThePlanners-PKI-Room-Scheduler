...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works}\index{How it works@{How it works}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20653}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20653}%
 \hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20654}{}\doxysection{\texorpdfstring{The problem}{The problem}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20654}
...
{\bfseries{The crux\+:}} How to identify what contributed to the SASS compilation, internally and post factum, but from within Webpack? 😫\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20655}{}\doxysection{\texorpdfstring{The solution}{The solution}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20655}
Sourcemaps! 😃
...
The SASS source-\/map is also something we can access from within Webpack.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20656}{}\doxysubsection{\texorpdfstring{concept}{concept}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20656}
...
Meanwhile the indirect {\ttfamily @mixin} and {\ttfamily funtion} substitutes values into the output. But we can still clearly see where in the source that final value originated from.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20657}{}\doxysubsection{\texorpdfstring{algorithm}{algorithm}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20657}
...
If necessary the order can be customised or a custom file search (starting at each location) be implemented. Refer to the \doxysectlink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2advanced-features}{advanced features}{0}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20658}{}\doxysubsection{\texorpdfstring{webpack}{webpack}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20658}
...
Once the CSS reaches the {\ttfamily css-\/loader} webpack becomes aware of each of the asset files and will try to separately load and process them. You will need more Webpack configuration to make that work. Refer to the \doxysectlink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2troubleshooting}{troubleshooting docs}{0} before raising an issue.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20659}{}\doxysubsection{\texorpdfstring{beyond...?}{beyond...?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works_autotoc_md20659}
