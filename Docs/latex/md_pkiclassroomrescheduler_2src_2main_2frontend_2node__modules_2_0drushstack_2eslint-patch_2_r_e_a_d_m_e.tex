...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e}\index{"@rushstack/eslint-\/patch@{"@rushstack/eslint-\/patch}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2104}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2104}%
...
Contributions welcome! If you have more ideas for experimental ESLint enhancements that might benefit large scale monorepos, consider adding them to this patch.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2105}{}\doxysection{\texorpdfstring{eslint-\/bulk-\/suppressions feature}{eslint-\/bulk-\/suppressions feature}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2105}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2106}{}\doxysubsubsection{\texorpdfstring{What it does}{What it does}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2106}
...
The {\ttfamily eslint-\/bulk-\/suppressions} feature introduces a way to store machine-\/generated suppressions in a separate file \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}.eslint-\/bulk-\/suppressions.\+json\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} which can even be protected using {\ttfamily CODEOWNERS} policies, since that file will generally only change when new lint rules are introduced, or in occasional circumstances when existing files are being moved or renamed. In this way {\ttfamily // eslint-\/ignore-\/next-\/line} remains a directive written by humans and hopefully rarely needed.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2107}{}\doxysubsubsection{\texorpdfstring{Why it\textquotesingle{}s a patch}{Why it\textquotesingle{}s a patch}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2107}
As with {\ttfamily modern-\/module-\/resolution}, our hope is for this feature to eventually be incorporated as an official feature of ESLint. Starting out as an unofficial patch allows faster iteration and community feedback.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2108}{}\doxysubsubsection{\texorpdfstring{How to use it}{How to use it}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2108}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{require("{}@rushstack/eslint-\/patch/eslint-\/bulk-\/suppressions"{});\ //\ 👈\ add\ this\ line}
\DoxyCodeLine{}
...
\end{DoxyEnumerate}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2109}{}\doxysubsubsection{\texorpdfstring{"{}eslint-\/bulk suppress"{} command}{"{}eslint-\/bulk suppress"{} command}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2109}
...
Use this command to automatically generate bulk suppressions for the specified lint rules and file paths. The path argument is a \href{https://en.wikipedia.org/wiki/Glob_(programming)}{\texttt{ glob pattern}} with the same syntax as path arguments for the {\ttfamily eslint} command.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2110}{}\doxysubsubsection{\texorpdfstring{"{}eslint-\/bulk prune"{} command}{"{}eslint-\/bulk prune"{} command}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2110}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2111}{}\doxysubsubsection{\texorpdfstring{Implementation notes}{Implementation notes}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2111}
...
\end{DoxyCode}
 The {\ttfamily rule} field is the ESLint rule name. The {\ttfamily file} field is the source file path, relative to the {\bfseries{eslintrc.\+js}} file. The {\ttfamily scope\+Id} is a special string built from the names of containing structures. (For implementation details, take a look at the \href{https://github.com/microsoft/rushstack/blob/e95c51088341f01516ee5a7639d57c3f6dce8772/eslint/eslint-patch/src/eslint-bulk-suppressions/bulk-suppressions-patch.ts\#L52}{\texttt{ calculate\+Scope\+Id()}} function.) The {\ttfamily scope\+Id} identifies a region of code where the rule should be suppressed, while being reasonably stable across edits of the source file.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2112}{}\doxysection{\texorpdfstring{modern-\/module-\/resolution feature}{modern-\/module-\/resolution feature}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2112}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2113}{}\doxysubsubsection{\texorpdfstring{What it does}{What it does}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2113}
...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2114}{}\doxysubsubsection{\texorpdfstring{Why it\textquotesingle{}s a patch}{Why it\textquotesingle{}s a patch}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2114}
We initially proposed this feature in a pull request for the official ESLint back in 2019, however the maintainers preferred to implement a more comprehensive overhaul of the ESLint config engine. It ultimately shipped with the experimental new {\ttfamily ESLINT\+\_\+\+USE\+\_\+\+FLAT\+\_\+\+CONFIG} mode (still opt-\/in as of ESLint 8). While waiting for that, Rush Stack\textquotesingle{}s {\ttfamily modern-\/module-\/resolution} patch provided a reliable interim solution. We will continue to maintain this patch as long as it is being widely used, but we encourage you to check out {\ttfamily ESLINT\+\_\+\+USE\+\_\+\+FLAT\+\_\+\+CONFIG} and see if it meets your needs.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2115}{}\doxysubsubsection{\texorpdfstring{How to use it}{How to use it}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2115}
...
\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}.eslintrc.\+js\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} 
\begin{DoxyCode}{0}
\DoxyCodeLine{require("{}@rushstack/eslint-\/patch/modern-\/module-\/resolution"{});\ //\ 👈\ add\ this\ line}
\DoxyCodeLine{}
...
For an even leaner setup, {\ttfamily @your-\/company/eslint-\/config} can provide the patches as its own dependency. See \href{https://github.com/microsoft/rushstack/blob/main/eslint/eslint-config/patch/modern-module-resolution.js}{\texttt{ @rushstack/eslint-\/config}} for a real world example.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2116}{}\doxysection{\texorpdfstring{custom-\/config-\/package-\/names feature}{custom-\/config-\/package-\/names feature}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2116}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2117}{}\doxysubsubsection{\texorpdfstring{What it does}{What it does}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2117}
...
\DoxyCodeLine{require("{}@rushstack/eslint-\/patch/custom-\/config-\/package-\/names"{});\ //\ 👈\ add\ this\ line}
\DoxyCodeLine{}
\DoxyCodeLine{//\ Add\ your\ "{}extends"{}\ boilerplate\ here,\ for\ example:}
\DoxyCodeLine{module.exports\ =\ \{}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2119}{}\doxysection{\texorpdfstring{Links}{Links}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drushstack_2eslint-patch_2_r_e_a_d_m_e_autotoc_md2119}
