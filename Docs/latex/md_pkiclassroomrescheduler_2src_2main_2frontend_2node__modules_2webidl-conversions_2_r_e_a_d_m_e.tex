...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e}\index{Web IDL Type Conversions on JavaScript Values@{Web IDL Type Conversions on JavaScript Values}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e_autotoc_md26514}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e_autotoc_md26514}%
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e_autotoc_md26515}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e_autotoc_md26515}
...
Specific conversions may also accept other options, the details of which can be found below.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e_autotoc_md26516}{}\doxysection{\texorpdfstring{Conversions implemented}{Conversions implemented}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e_autotoc_md26516}
...
Derived types, such as nullable types, promise types, sequences, records, etc. are not handled by this library. You may wish to investigate the \href{https://github.com/jsdom/webidl2js}{\texttt{ webidl2js}} project.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e_autotoc_md26517}{}\doxysubsection{\texorpdfstring{A note on the {\ttfamily long long} types}{A note on the {\ttfamily long long} types}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e_autotoc_md26517}
...
On the other hand, {\ttfamily long long} conversion is always accurate, since the input value can never be more precise than the output value.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e_autotoc_md26518}{}\doxysubsection{\texorpdfstring{A note on {\ttfamily Buffer\+Source} types}{A note on {\ttfamily Buffer\+Source} types}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e_autotoc_md26518}
All of the {\ttfamily Buffer\+Source} types will throw when the relevant {\ttfamily Array\+Buffer} has been detached. This technically is not part of the \href{https://heycam.github.io/webidl/\#es-buffer-source-types}{\texttt{ specified conversion algorithm}}, but instead part of the \href{https://heycam.github.io/webidl/\#ref-for-dfn-get-buffer-source-reference\%E2\%91\%A0}{\texttt{ getting a reference/getting a copy}} algorithms. We\textquotesingle{}ve consolidated them here for convenience and ease of implementation, but if there is a need to separate them in the future, please open an issue so we can investigate.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e_autotoc_md26519}{}\doxysection{\texorpdfstring{Background}{Background}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2webidl-conversions_2_r_e_a_d_m_e_autotoc_md26519}
