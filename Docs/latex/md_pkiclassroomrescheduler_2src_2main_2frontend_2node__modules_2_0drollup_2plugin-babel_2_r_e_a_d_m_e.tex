\chapter{README}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e}\index{README@{README}}
\href{https://www.npmjs.com/package/@rollup/plugin-babel}{\texttt{ }} \href{https://packagephobia.now.sh/result?p=@rollup/plugin-babel}{\texttt{ }} \href{https://liberamanifesto.com}{\texttt{ }}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1837}{}\doxysection{\texorpdfstring{@rollup/plugin-\/babel}{@rollup/plugin-\/babel}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1837}
🍣 A Rollup plugin for seamless integration between Rollup and Babel.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1838}{}\doxysubsection{\texorpdfstring{Why?}{Why?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1838}
...
Using Rollup with {\ttfamily @rollup/plugin-\/babel} makes the process far easier.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1839}{}\doxysubsection{\texorpdfstring{Requirements}{Requirements}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1839}
This plugin requires an \href{https://github.com/nodejs/Release}{\texttt{ LTS}} Node version (v10.\+0.\+0+) and Rollup v1.\+20.\+0+.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1840}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1840}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ install\ @rollup/plugin-\/babel\ -\/-\/save-\/dev}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1841}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1841}
...
Then call {\ttfamily rollup} either via the \href{https://www.rollupjs.org/guide/en/\#command-line-reference}{\texttt{ CLI}} or the \href{https://www.rollupjs.org/guide/en/\#javascript-api}{\texttt{ API}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1842}{}\doxysubsubsection{\texorpdfstring{Using With {\ttfamily @rollup/plugin-\/commonjs}}{Using With {\ttfamily @rollup/plugin-\/commonjs}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1842}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1843}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1843}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1847}{}\doxysubsubsection{\texorpdfstring{{\ttfamily extensions}}{{\ttfamily extensions}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1847}
...
An array of file extensions that Babel should transpile. If you want to transpile Type\+Script files with this plugin it\textquotesingle{}s essential to include {\ttfamily .ts} and {\ttfamily .tsx} in this option.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1848}{}\doxysubsubsection{\texorpdfstring{{\ttfamily babel\+Helpers}}{{\ttfamily babel\+Helpers}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1848}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1849}{}\doxysubsubsection{\texorpdfstring{{\ttfamily skip\+Preflight\+Check}}{{\ttfamily skip\+Preflight\+Check}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1849}
Type\+: {\ttfamily Boolean}~\newline
 Default\+: {\ttfamily false}

Before transpiling your input files this plugin also transpile a short piece of code {\bfseries{for each}} input file. This is used to validate some misconfiguration errors, but for sufficiently big projects it can slow your build times so if you are confident about your configuration then you might disable those checks with this option.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1850}{}\doxysubsubsection{\texorpdfstring{External dependencies}{External dependencies}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1850}
...
Use {\ttfamily babelrc\+: false} to prevent Babel from using local (i.\+e. to your external dependencies) {\ttfamily .babelrc} files, relying instead on the configuration you pass in.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1851}{}\doxysubsubsection{\texorpdfstring{Helpers}{Helpers}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1851}
In some cases Babel uses {\itshape helpers} to avoid repeating chunks of code – for example, if you use the {\ttfamily class} keyword, it will use a {\ttfamily class\+Call\+Check} function to ensure that the class is instantiated correctly.
...
You can customize how those helpers are being inserted into the transformed file with \`{}babel\+Helpers\`{} option.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1852}{}\doxysubsubsection{\texorpdfstring{Modules}{Modules}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1852}
...
If you have been pointed to this section by an error thrown by this plugin, please check your Babel configuration files and disable any module transforms when running Rollup builds.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1853}{}\doxysubsection{\texorpdfstring{Running Babel on the generated code}{Running Babel on the generated code}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1853}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1854}{}\doxysubsubsection{\texorpdfstring{Babel configuration files}{Babel configuration files}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1854}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1855}{}\doxysubsubsection{\texorpdfstring{Using formats other than ES modules or Common\+JS}{Using formats other than ES modules or Common\+JS}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1855}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1856}{}\doxysubsubsection{\texorpdfstring{Injected helpers}{Injected helpers}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1856}
...
Another option is to use {\ttfamily @babel/plugin-\/external-\/helpers}, which will reference the global {\ttfamily babel\+Helpers} object. It is your responsibility to make sure this global variable exists.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1857}{}\doxysubsection{\texorpdfstring{Custom plugin builder}{Custom plugin builder}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1857}
...
It\textquotesingle{}s main purpose is to allow other tools for configuration of transpilation without forcing people to add extra configuration but still allow for using their own babelrc / babel config files.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1858}{}\doxysubsubsection{\texorpdfstring{Example}{Example}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1858}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1859}{}\doxysubsection{\texorpdfstring{Meta}{Meta}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0drollup_2plugin-babel_2_r_e_a_d_m_e_autotoc_md1859}
CONTRIBUTING
