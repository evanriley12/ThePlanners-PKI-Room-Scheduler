\chapter{README}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e}\index{README@{README}}


 \hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14082}{}\doxysection{\texorpdfstring{node-\/http-\/proxy \href{https://travis-ci.org/http-party/node-http-proxy}{\texttt{ }} \href{https://codecov.io/gh/http-party/node-http-proxy}{\texttt{ }}}{node-\/http-\/proxy \href{https://travis-ci.org/http-party/node-http-proxy}{\texttt{ }} \href{https://codecov.io/gh/http-party/node-http-proxy}{\texttt{ }}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14082}
{\ttfamily node-\/http-\/proxy} is an HTTP programmable proxying library that supports websockets. It is suitable for implementing components such as reverse proxies and load balancers.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14083}{}\doxysubsubsection{\texorpdfstring{Table of Contents}{Table of Contents}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14083}
...
\item License
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14084}{}\doxysubsubsection{\texorpdfstring{Installation}{Installation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14084}
{\ttfamily npm install http-\/proxy -\/-\/save}

{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14085}{}\doxysubsubsection{\texorpdfstring{Upgrading from 0.\+8.\+x ?}{Upgrading from 0.\+8.\+x ?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14085}
Click here

{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14086}{}\doxysubsubsection{\texorpdfstring{Core Concept}{Core Concept}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14086}
...
{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14087}{}\doxysubsubsection{\texorpdfstring{Use Cases}{Use Cases}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14087}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14088}{}\doxyparagraph{\texorpdfstring{Setup a basic stand-\/alone proxy server}{Setup a basic stand-\/alone proxy server}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14088}
...
{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14089}{}\doxyparagraph{\texorpdfstring{Setup a stand-\/alone proxy server with custom server logic}{Setup a stand-\/alone proxy server with custom server logic}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14089}
...
{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14090}{}\doxyparagraph{\texorpdfstring{Setup a stand-\/alone proxy server with proxy request header re-\/writing}{Setup a stand-\/alone proxy server with proxy request header re-\/writing}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14090}
...
{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14091}{}\doxyparagraph{\texorpdfstring{Modify a response from a proxied server}{Modify a response from a proxied server}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14091}
...
{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14092}{}\doxyparagraph{\texorpdfstring{Setup a stand-\/alone proxy server with latency}{Setup a stand-\/alone proxy server with latency}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14092}
...
{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14093}{}\doxyparagraph{\texorpdfstring{Using HTTPS}{Using HTTPS}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14093}
...
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14094}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14094}%
...
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14095}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14095}%
...
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14096}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14096}%
...
{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14097}{}\doxyparagraph{\texorpdfstring{Proxying Web\+Sockets}{Proxying Web\+Sockets}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14097}
...
{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14098}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14098}
...
{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14099}{}\doxysubsubsection{\texorpdfstring{Listening for proxy events}{Listening for proxy events}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14099}
...
{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14100}{}\doxysubsubsection{\texorpdfstring{Shutdown}{Shutdown}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14100}
...
{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14101}{}\doxysubsubsection{\texorpdfstring{Miscellaneous}{Miscellaneous}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14101}
If you want to handle your own response after receiving the {\ttfamily proxy\+Res}, you can do so with {\ttfamily self\+Handle\+Response}. As you can see below, if you use this option, you are able to intercept and read the {\ttfamily proxy\+Res} but you must also make sure to reply to the {\ttfamily res} itself otherwise the original client will never receive any data.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14102}{}\doxysubsubsection{\texorpdfstring{Modify response}{Modify response}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14102}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14103}{}\doxyparagraph{\texorpdfstring{Proxy\+Table API}{Proxy\+Table API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14103}
A proxy table API is available through this add-\/on \href{https://github.com/donasaur/http-proxy-rules}{\texttt{ module}}, which lets you define a set of rules to translate matching routes to target routes that the reverse proxy will talk to.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14104}{}\doxyparagraph{\texorpdfstring{Test}{Test}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14104}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14105}{}\doxyparagraph{\texorpdfstring{Logo}{Logo}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14105}
Logo created by \href{http://dribbble.com/diegopq}{\texttt{ Diego Pasquali}}

{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14106}{}\doxysubsubsection{\texorpdfstring{Contributing and Issues}{Contributing and Issues}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14106}
...
{\bfseries{Back to top}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14107}{}\doxysubsubsection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy_2_r_e_a_d_m_e_autotoc_md14107}
