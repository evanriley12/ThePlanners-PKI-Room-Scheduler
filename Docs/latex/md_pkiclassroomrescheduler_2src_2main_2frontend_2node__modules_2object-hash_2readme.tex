\chapter{object-\/hash}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme}\index{object-\/hash@{object-\/hash}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17342}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17342}%
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17343}{}\doxysection{\texorpdfstring{Versioning Disclaimer}{Versioning Disclaimer}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17343}
...
For more information, see \href{https://github.com/puleos/object-hash/issues/30}{\texttt{ this discussion}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17344}{}\doxysection{\texorpdfstring{hash(value, options)}{hash(value, options)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17344}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17345}{}\doxysection{\texorpdfstring{hash.\+sha1(value)}{hash.\+sha1(value)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17345}
...
{\itshape Sugar method, equivalent to} `hash(value, \{algorithm\+: \textquotesingle{}sha1'\})\`{}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17346}{}\doxysection{\texorpdfstring{hash.\+keys(value)}{hash.\+keys(value)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17346}
Hash object keys using the sha1 algorithm, values ignored.

{\itshape Sugar method, equivalent to} {\ttfamily hash(value, \{exclude\+Values\+: true\})}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17347}{}\doxysection{\texorpdfstring{hash.\+MD5(value)}{hash.\+MD5(value)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17347}
...
{\itshape Sugar method, equivalent to} `hash(value, \{algorithm\+: \textquotesingle{}md5'\})\`{}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17348}{}\doxysection{\texorpdfstring{hash.\+keys\+MD5(value)}{hash.\+keys\+MD5(value)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17348}
Hash object keys using the md5 algorithm, values ignored.

Note that the MD5 algorithm is not considered secure, and a stronger algorithm should be used if a cryptographical hash is desired.

{\itshape Sugar method, equivalent to} `hash(value, \{algorithm\+: \textquotesingle{}md5', exclude\+Values\+: true\})\`{}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17349}{}\doxysection{\texorpdfstring{hash.\+write\+To\+Stream(value, \mbox{[}options,\mbox{]} stream)}{hash.\+write\+To\+Stream(value, \mbox{[}options,\mbox{]} stream)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17349}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17350}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17350}
node\+:
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17351}{}\doxysection{\texorpdfstring{Example usage}{Example usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17351}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17352}{}\doxysection{\texorpdfstring{Legacy Browser Support}{Legacy Browser Support}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17352}
IE \texorpdfstring{$<$}{<}= 8 and Opera \texorpdfstring{$<$}{<}= 11 support dropped in version 0.\+3.\+0. If you require legacy browser support you must either use an ES5 shim or use version 0.\+2.\+5 of this module.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17353}{}\doxysection{\texorpdfstring{Development}{Development}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17353}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17354}{}\doxysection{\texorpdfstring{Node Docker Wrapper}{Node Docker Wrapper}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17354}
If you want to stand this up in a docker container, you should take at look at the \href{https://github.com/bean5/node-object-hash}{\texttt{ }} project.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17355}{}\doxysubsection{\texorpdfstring{gulp tasks}{gulp tasks}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17355}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17356}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17356}
MIT\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17357}{}\doxysection{\texorpdfstring{Changelog}{Changelog}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17357}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17358}{}\doxysubsection{\texorpdfstring{v2.\+0.\+0}{v2.\+0.\+0}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2object-hash_2readme_autotoc_md17358}
