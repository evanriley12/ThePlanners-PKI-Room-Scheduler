...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e}\index{Source Map Support@{Source Map Support}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23455}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23455}%
\href{https://travis-ci.org/evanw/node-source-map-support}{\texttt{ }}

This module provides source map support for stack traces in node via the \href{https://github.com/v8/v8/wiki/Stack-Trace-API}{\texttt{ V8 stack trace API}}. It uses the \href{https://github.com/mozilla/source-map}{\texttt{ source-\/map}} module to replace the paths and line numbers of source-\/mapped files with their original paths and line numbers. The output mimics node\textquotesingle{}s stack trace format with the goal of making every compile-\/to-\/\+JS language more of a first-\/class citizen. Source maps are completely general (not specific to any one language) so you can use source maps with multiple compile-\/to-\/\+JS languages in the same node process.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23456}{}\doxysection{\texorpdfstring{Installation and Usage}{Installation and Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23456}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23457}{}\doxysubsubsection{\texorpdfstring{Node support}{Node support}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23457}
...
From here you have two options.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23458}{}\doxyparagraph{\texorpdfstring{CLI Usage}{CLI Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23458}

\begin{DoxyCode}{0}
\DoxyCodeLine{node\ -\/r\ source-\/map-\/support/register\ compiled.js}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23459}{}\doxyparagraph{\texorpdfstring{Programmatic Usage}{Programmatic Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23459}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23460}{}\doxysubsubsection{\texorpdfstring{Browser support}{Browser support}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23460}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23461}{}\doxysection{\texorpdfstring{Options}{Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23461}
...
This monkey patches the {\ttfamily require} module loading chain, so is not enabled by default and is not recommended for any sort of production usage.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23462}{}\doxysection{\texorpdfstring{Demos}{Demos}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23462}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23463}{}\doxysubsubsection{\texorpdfstring{Basic Demo}{Basic Demo}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23463}
original.\+js\+:
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23464}{}\doxysubsubsection{\texorpdfstring{Type\+Script Demo}{Type\+Script Demo}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23464}
demo.\+ts\+:
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23465}{}\doxysubsubsection{\texorpdfstring{Coffee\+Script Demo}{Coffee\+Script Demo}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23465}
demo.\+coffee\+:
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23466}{}\doxysection{\texorpdfstring{Tests}{Tests}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23466}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23467}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2source-map-support_2_r_e_a_d_m_e_autotoc_md23467}
