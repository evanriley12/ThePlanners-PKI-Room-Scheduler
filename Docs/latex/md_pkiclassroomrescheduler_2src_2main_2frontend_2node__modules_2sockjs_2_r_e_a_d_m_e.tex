\chapter{README}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e}\index{README@{README}}
\href{http://badge.fury.io/js/sockjs}{\texttt{ }}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23283}{}\doxysection{\texorpdfstring{What is Sock\+JS?}{What is Sock\+JS?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23283}
Sock\+JS is a Java\+Script library (for browsers) that provides a Web\+Socket-\/like object. Sock\+JS gives you a coherent, cross-\/browser, Javascript API which creates a low latency, full duplex, cross-\/domain communication channel between the browser and the web server, with Web\+Sockets or without. This necessitates the use of a server, which this is one version of, for Node.\+js.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23284}{}\doxysection{\texorpdfstring{Sock\+JS-\/node server}{Sock\+JS-\/node server}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23284}
...
Subscribe to \href{https://groups.google.com/forum/\#!forum/sockjs}{\texttt{ Sock\+JS mailing list}} for discussions and support.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23285}{}\doxysubsection{\texorpdfstring{Sock\+JS-\/node API}{Sock\+JS-\/node API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23285}
The API design is based on common Node APIs like the \href{http://nodejs.org/docs/v0.5.8/api/streams.html}{\texttt{ Streams API}} or the \href{http://nodejs.org/docs/v0.5.8/api/http.html\#http.Server}{\texttt{ Http.\+Server API}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23286}{}\doxysubsubsection{\texorpdfstring{Server class}{Server class}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23286}
...
\item[jsessionid (boolean or function) ]Some hosting providers enable sticky sessions only to requests that have JSESSIONID cookie set. This setting controls if the server should set this cookie to a dummy value. By default setting JSESSIONID cookie is disabled. More sophisticated behaviour can be achieved by supplying a function.


\item[log (function(severity, message)) ]It\textquotesingle{}s quite useful, especially for debugging, to see some messages printed by a Sock\+JS-\/node library. This is done using this {\ttfamily log} function, which is by default set to {\ttfamily console.\+log}. If this behaviour annoys you for some reason, override {\ttfamily log} setting with a custom handler. The following {\ttfamily severities} are used\+: {\ttfamily debug} (miscellaneous logs), {\ttfamily info} (requests logs), {\ttfamily error} (serious errors, consider filing an issue).
...
\item[disable\+\_\+cors (boolean) ]Enabling this option will prevent \href{https://en.wikipedia.org/wiki/Cross-origin_resource_sharing}{\texttt{ CORS}} headers from being included in the HTTP response. Can be used when the sockjs client is known to be connecting from the same origin as the sockjs server. 
\end{DoxyDescription}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23287}{}\doxysubsubsection{\texorpdfstring{Server instance}{Server instance}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23287}
...
All http requests that don\textquotesingle{}t go under the path selected by {\ttfamily prefix} will remain unanswered and will be passed to previously registered handlers. You must install your custom http handlers before calling {\ttfamily install\+Handlers}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23288}{}\doxysubsubsection{\texorpdfstring{Connection instance}{Connection instance}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23288}
...
\item[Property\+: url (string) ]\href{http://nodejs.org/docs/v0.4.10/api/http.html\#request.url}{\texttt{ Url}} property copied from last request.
...
\item[Property\+: protocol (string) ]Protocol used by the connection. Keep in mind that some protocols are indistinguishable -\/ for example "{}xhr-\/polling"{} and "{}xdr-\/polling"{}.
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23289}{}\doxysubsubsection{\texorpdfstring{Footnote}{Footnote}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23289}
A fully working echo server does need a bit more boilerplate (to handle requests unanswered by Sock\+JS), see the \href{https://github.com/sockjs/sockjs-node/tree/master/examples/echo}{\texttt{ {\ttfamily echo} example}} for a complete code.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23290}{}\doxysubsubsection{\texorpdfstring{Examples}{Examples}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23290}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23291}{}\doxysubsection{\texorpdfstring{Connecting to Sock\+JS-\/node without the client}{Connecting to Sock\+JS-\/node without the client}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23291}
...
Note\+: This endpoint will {\itshape not send any heartbeat packets}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23292}{}\doxysubsection{\texorpdfstring{Deployment and load balancing}{Deployment and load balancing}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23292}
There are two issues that need to be considered when planning a non-\/trivial Sock\+JS-\/node deployment\+: Web\+Socket-\/compatible load balancer and sticky sessions (aka session affinity).\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23293}{}\doxysubsubsection{\texorpdfstring{Web\+Socket compatible load balancer}{Web\+Socket compatible load balancer}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23293}
...
The config also shows how to use HAproxy balancing to split traffic between multiple Node.\+js servers. You can also do balancing using dns names.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23294}{}\doxysubsubsection{\texorpdfstring{Sticky sessions}{Sticky sessions}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23294}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23295}{}\doxysubsection{\texorpdfstring{Development and testing}{Development and testing}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23295}
...
\end{DoxyVerb}
 \hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23296}{}\doxysubsubsection{\texorpdfstring{Sock\+JS-\/protocol Python tests}{Sock\+JS-\/protocol Python tests}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23296}
To run it run something like\+: \begin{DoxyVerb}cd sockjs-protocol
make test_deps
./venv/bin/python sockjs-protocol.py
\end{DoxyVerb}
 For details see \href{https://github.com/sockjs/sockjs-protocol\#readme}{\texttt{ Sock\+JS-\/protocol README}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23297}{}\doxysubsubsection{\texorpdfstring{Sock\+JS-\/client QUnit tests}{Sock\+JS-\/client QUnit tests}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23297}
...
Additionally, if you\textquotesingle{}re doing more serious development consider using {\ttfamily make serve}, which will automatically the server when you modify the source code.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23298}{}\doxysubsection{\texorpdfstring{Various issues and design considerations}{Various issues and design considerations}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23298}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23299}{}\doxysubsubsection{\texorpdfstring{Authorisation}{Authorisation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23299}
...
Basically -\/ cookies are not suited for Sock\+JS model. If you want to authorise a session -\/ provide a unique token on a page, send it as a first thing over Sock\+JS connection and validate it on the server side. In essence, this is how cookies work.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23300}{}\doxysubsubsection{\texorpdfstring{Deploying Sock\+JS on Heroku}{Deploying Sock\+JS on Heroku}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sockjs_2_r_e_a_d_m_e_autotoc_md23300}
