\chapter{http-\/errors}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e}\index{http-\/errors@{http-\/errors}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13750}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13750}%
...
Create HTTP errors for Express, Koa, Connect, etc. with ease.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13751}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13751}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13752}{}\doxysection{\texorpdfstring{Example}{Example}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13752}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13753}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13753}
This is the current API, currently extracted from Koa and subject to change.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13754}{}\doxysubsection{\texorpdfstring{Error Properties}{Error Properties}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13754}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13755}{}\doxysubsection{\texorpdfstring{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}message\mbox{]}, \mbox{[}properties\mbox{]})}{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}message\mbox{]}, \mbox{[}properties\mbox{]})}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13755}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13756}{}\doxysubsection{\texorpdfstring{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}error\mbox{]}, \mbox{[}properties\mbox{]})}{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}error\mbox{]}, \mbox{[}properties\mbox{]})}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13756}
...
\item {\ttfamily properties} -\/ custom properties to attach to the object
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13757}{}\doxysubsection{\texorpdfstring{create\+Error.\+is\+Http\+Error(val)}{create\+Error.\+is\+Http\+Error(val)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13757}
Determine if the provided {\ttfamily val} is an {\ttfamily Http\+Error}. This will return {\ttfamily true} if the error inherits from the {\ttfamily Http\+Error} constructor of this module or matches the "{}duck type"{} for an error this module creates. All outputs from the {\ttfamily create\+Error} factory will return {\ttfamily true} for this function, including if an non-\/{\ttfamily Http\+Error} was passed into the factory.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13758}{}\doxysubsection{\texorpdfstring{new create\+Error\mbox{[}code \texorpdfstring{$\vert$}{|}\texorpdfstring{$\vert$}{|} name\mbox{]}(\mbox{[}msg\mbox{]}))}{new create\+Error\mbox{[}code \texorpdfstring{$\vert$}{|}\texorpdfstring{$\vert$}{|} name\mbox{]}(\mbox{[}msg\mbox{]}))}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13758}
Create a new error object with the given message {\ttfamily msg}. The error object inherits from {\ttfamily create\+Error.\+Http\+Error}.
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13759}{}\doxysubsubsection{\texorpdfstring{List of all constructors}{List of all constructors}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13759}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13760}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-errors_2_r_e_a_d_m_e_autotoc_md13760}
