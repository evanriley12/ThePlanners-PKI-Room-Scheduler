...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e}\index{PostCSS Preset Env $<$a href="{}https://github.com/postcss/postcss"{} $>$$<$img src=\textbackslash{}"{}https://postcss.github.io/postcss/logo.svg\textbackslash{}"{} alt=\textbackslash{}"{}PostCSS\textbackslash{}"{} width=\textbackslash{}"{}90\textbackslash{}"{} height=\textbackslash{}"{}90\textbackslash{}"{} align=\textbackslash{}"{}right\textbackslash{}"{}$>$$<$/a$>$@{PostCSS Preset Env $<$a href=""https://github.com/postcss/postcss"" $>$$<$img src=\textbackslash{}""https://postcss.github.io/postcss/logo.svg\textbackslash{}"" alt=\textbackslash{}""PostCSS\textbackslash{}"" width=\textbackslash{}""90\textbackslash{}"" height=\textbackslash{}""90\textbackslash{}"" align=\textbackslash{}""right\textbackslash{}""$>$$<$/a$>$}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19363}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19363}%
...
\href{https://github.com/csstools/postcss-plugins/tree/main/plugin-packs/postcss-preset-env}{\texttt{ Post\+CSS Preset Env}} lets you convert modern CSS into something most browsers can understand, determining the polyfills you need based on your targeted browsers or runtime environments.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19364}{}\doxysection{\texorpdfstring{Quick start}{Quick start}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19364}
...
{\itshape \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dtypes_2jest_2node__modules_2_0dsinclair_2typebox_2readme_usage}{Read more on how to use and install Post\+CSS Preset Env.}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19365}{}\doxysection{\texorpdfstring{How does it work?}{How does it work?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19365}
...
What \href{https://github.com/csstools/postcss-plugins/tree/main/plugin-packs/postcss-preset-env}{\texttt{ Post\+CSS Preset Env}} does is to take the support data that comes from MDN and Can I Use and determine from a \href{https://github.com/browserslist/browserslist}{\texttt{ browserlist}} whether those transformations are needed. It also packs \href{https://github.com/postcss/autoprefixer}{\texttt{ Autoprefixer}} within and shares the list with it, so prefixes are only applied when you\textquotesingle{}re going to need them given your browser support list.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19366}{}\doxysubsection{\texorpdfstring{Glossary\+:}{Glossary\+:}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19366}
...
See the list below.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19367}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19367}
...
\texorpdfstring{$\vert$}{|} \href{INSTALL.md\#node}{\texttt{ Node}} \texorpdfstring{$\vert$}{|} \href{INSTALL.md\#postcss-cli}{\texttt{ Post\+CSS CLI}} \texorpdfstring{$\vert$}{|} \href{INSTALL.md\#webpack}{\texttt{ Webpack}} \texorpdfstring{$\vert$}{|} \href{INSTALL.md\#create-react-app}{\texttt{ Create React App}} \texorpdfstring{$\vert$}{|} \href{INSTALL.md\#gulp}{\texttt{ Gulp}} \texorpdfstring{$\vert$}{|} \href{INSTALL.md\#grunt}{\texttt{ Grunt}} \texorpdfstring{$\vert$}{|} \href{INSTALL.md\#rollup}{\texttt{ Rollup}} \texorpdfstring{$\vert$}{|} \texorpdfstring{$\vert$}{|} --- \texorpdfstring{$\vert$}{|} --- \texorpdfstring{$\vert$}{|} --- \texorpdfstring{$\vert$}{|} --- \texorpdfstring{$\vert$}{|} --- \texorpdfstring{$\vert$}{|} --- \texorpdfstring{$\vert$}{|} --- \texorpdfstring{$\vert$}{|}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19368}{}\doxysection{\texorpdfstring{Options}{Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19368}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19369}{}\doxysubsection{\texorpdfstring{stage}{stage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19369}
...
Default\+: {\ttfamily 2}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19370}{}\doxysubsection{\texorpdfstring{minimum\+Vendor\+Implementations}{minimum\+Vendor\+Implementations}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19370}
...
Having 2 independent implementations is \href{https://www.w3.org/2021/Process-20211102/\#implementation-experience}{\texttt{ a critical step in proposals becoming standards}} and a good indicator of a feature\textquotesingle{}s stability.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19371}{}\doxysubsection{\texorpdfstring{features}{features}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19371}
...
Any polyfills not explicitly enabled or disabled through {\ttfamily features} are determined by the \`{}stage\`{} option.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19372}{}\doxysubsection{\texorpdfstring{browsers}{browsers}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19372}
...
If no valid browserslist configuration is specified, the \href{https://github.com/browserslist/browserslist\#queries}{\texttt{ default browserslist query}} will be used.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19373}{}\doxysubsection{\texorpdfstring{insert\+Before / insert\+After}{insert\+Before / insert\+After}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19373}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19374}{}\doxysubsection{\texorpdfstring{autoprefixer}{autoprefixer}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19374}
...
{\itshape older Edge is any version before chromium (\texorpdfstring{$<$}{<}79)}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19375}{}\doxysubsection{\texorpdfstring{preserve}{preserve}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19375}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19376}{}\doxysubsection{\texorpdfstring{import\+From}{import\+From}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19376}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19377}{}\doxysubsection{\texorpdfstring{export\+To}{export\+To}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19377}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19378}{}\doxysubsection{\texorpdfstring{debug}{debug}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19378}
The {\ttfamily debug} option enables debugging messages to stdout which should be useful to help you debug which features have been enabled/disabled and why.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19379}{}\doxysubsection{\texorpdfstring{enable\+Client\+Side\+Polyfills}{enable\+Client\+Side\+Polyfills}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19379}
...
Note that manually enabling/disabling features via the "{}feature"{} option overrides this flag.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19380}{}\doxysection{\texorpdfstring{Stability and Portability}{Stability and Portability}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19380}
...
A side effect of staying close to the standard is that you can more easily migrate your project to other tooling all together.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19381}{}\doxysection{\texorpdfstring{Plugins list}{Plugins list}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19381}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19382}{}\doxysubsection{\texorpdfstring{Plugins that need client library}{Plugins that need client library}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19382}
...
If you want to disable these types of features, please check the \`{}enable\+Client\+Side\+Polyfills\`{} option.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19383}{}\doxysubsection{\texorpdfstring{Plugins not affected by Browser Support}{Plugins not affected by Browser Support}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2postcss-preset-env_2_r_e_a_d_m_e_autotoc_md19383}
