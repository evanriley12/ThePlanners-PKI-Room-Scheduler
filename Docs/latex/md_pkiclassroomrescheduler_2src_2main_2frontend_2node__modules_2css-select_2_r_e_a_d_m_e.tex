...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e}\index{css-\/select $<$a href="{}https://npmjs.org/package/css-\/select"{} $>$$<$img src="{}http://img.shields.io/npm/v/css-\/select.svg"{} alt="{}NPM version"{}/$>$$<$/a$>$ $<$a href="{}http://travis-\/ci.com/fb55/css-\/select"{} $>$$<$img src="{}https://travis-\/ci.com/fb55/css-\/select.svg?branch=master"{} alt="{}Build Status"{}/$>$$<$/a$>$ $<$a href="{}https://npmjs.org/package/css-\/select"{} $>$$<$img src="{}https://img.shields.io/npm/dm/css-\/select.svg"{} alt="{}Downloads"{}/$>$$<$/a$>$ $<$a href="{}https://coveralls.io/r/fb55/css-\/select"{} $>$$<$img src="{}https://coveralls.io/repos/fb55/css-\/select/badge.svg?branch=master"{} alt="{}Coverage"{}/$>$$<$/a$>$@{css-\/select $<$a href=""https://npmjs.org/package/css-\/select"" $>$$<$img src=""http://img.shields.io/npm/v/css-\/select.svg"" alt=""NPM version""/$>$$<$/a$>$ $<$a href=""http://travis-\/ci.com/fb55/css-\/select"" $>$$<$img src=""https://travis-\/ci.com/fb55/css-\/select.svg?branch=master"" alt=""Build Status""/$>$$<$/a$>$ $<$a href=""https://npmjs.org/package/css-\/select"" $>$$<$img src=""https://img.shields.io/npm/dm/css-\/select.svg"" alt=""Downloads""/$>$$<$/a$>$ $<$a href=""https://coveralls.io/r/fb55/css-\/select"" $>$$<$img src=""https://coveralls.io/repos/fb55/css-\/select/badge.svg?branch=master"" alt=""Coverage""/$>$$<$/a$>$}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8002}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8002}%
 A CSS selector compiler and engine\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8003}{}\doxysection{\texorpdfstring{What?}{What?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8003}
...
In its default configuration, css-\/select queries the DOM structure of the \href{https://github.com/fb55/domhandler}{\texttt{ {\ttfamily domhandler}}} module (also known as htmlparser2 DOM). To query alternative DOM structures, see \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2node-forge_2_r_e_a_d_m_e_options}{\`{}\+Options\`{}} below.
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8004}{}\doxysection{\texorpdfstring{Why?}{Why?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8004}
...
And that\textquotesingle{}s what css-\/select does – and why it\textquotesingle{}s quite performant.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8005}{}\doxysection{\texorpdfstring{How does it work?}{How does it work?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8005}
...
\+\_\+//\+TODO\+: More in-\/depth description. Implementation details. Build a spaceship.\+\_\+\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8006}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8006}
...
{\bfseries{Note\+:}} css-\/select throws errors when invalid selectors are passed to it.\+This is done to aid with writing css selectors, but can be unexpected when processing arbitrary strings.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8007}{}\doxysubsubsection{\texorpdfstring{{\ttfamily CSSselect.\+select\+All(query, elems, options)}}{{\ttfamily CSSselect.\+select\+All(query, elems, options)}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8007}
...
Aliases\+: {\ttfamily default} export, {\ttfamily CSSselect.\+iterate(query, elems)}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8008}{}\doxysubsubsection{\texorpdfstring{{\ttfamily CSSselect.\+compile(query, options)}}{{\ttfamily CSSselect.\+compile(query, options)}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8008}
Compiles the query, returns a function.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8009}{}\doxysubsubsection{\texorpdfstring{{\ttfamily CSSselect.\+is(elem, query, options)}}{{\ttfamily CSSselect.\+is(elem, query, options)}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8009}
Tests whether or not an element is matched by {\ttfamily query}. {\ttfamily query} can be either a CSS selector or a function.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8010}{}\doxysubsubsection{\texorpdfstring{{\ttfamily CSSselect.\+select\+One(query, elems, options)}}{{\ttfamily CSSselect.\+select\+One(query, elems, options)}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8010}
Arguments are the same as for {\ttfamily CSSselect.\+select\+All(query, elems)}. Only returns the first match, or {\ttfamily null} if there was no match.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8011}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8011}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8012}{}\doxysubsubsection{\texorpdfstring{Custom Adapters}{Custom Adapters}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8012}
...
You may want to have a look at \href{https://github.com/fb55/domutils}{\texttt{ {\ttfamily domutils}}} to see the default implementation, or at \href{https://github.com/nrkn/css-select-browser-adapter/blob/master/index.js}{\texttt{ {\ttfamily css-\/select-\/browser-\/adapter}}} for an implementation backed by the DOM.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8013}{}\doxysection{\texorpdfstring{Supported selectors}{Supported selectors}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8013}
...
License\+: BSD-\/2-\/\+Clause\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8015}{}\doxysection{\texorpdfstring{Security contact information}{Security contact information}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8015}
To report a security vulnerability, please use the \href{https://tidelift.com/security}{\texttt{ Tidelift security contact}}. Tidelift will coordinate the fix and disclosure.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8016}{}\doxysection{\texorpdfstring{{\ttfamily css-\/select} for enterprise}{{\ttfamily css-\/select} for enterprise}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2css-select_2_r_e_a_d_m_e_autotoc_md8016}
