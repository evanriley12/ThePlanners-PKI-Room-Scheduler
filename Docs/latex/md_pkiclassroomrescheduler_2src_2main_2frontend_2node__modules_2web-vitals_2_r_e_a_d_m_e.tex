...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e}\index{$<$tt$>$web-\/vitals$<$/tt$>$@{$<$tt$>$web-\/vitals$<$/tt$>$}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26471}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26471}%
...
\item \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_installation}{Install and load the library}
\begin{DoxyItemize}
\item \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_import-web-vitals-from-npm}{From npm}
\item \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_load-web-vitals-from-a-cdn}{From a CDN}
\end{DoxyItemize}
...
\item Integrations
\item License
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26472}{}\doxysection{\texorpdfstring{Overview}{Overview}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26472}
...
The library supports all of the \href{https://web.dev/vitals/\#core-web-vitals}{\texttt{ Core Web Vitals}} as well as all of the \href{https://web.dev/vitals/\#other-web-vitals}{\texttt{ other Web Vitals}} that can be measured \href{https://web.dev/user-centric-performance-metrics/\#how-metrics-are-measured}{\texttt{ in the field}}\+:\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26473}{}\doxysubsection{\texorpdfstring{Core Web Vitals}{Core Web Vitals}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26473}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26474}{}\doxysubsection{\texorpdfstring{Other Web Vitals}{Other Web Vitals}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26474}
...
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_installation}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_installation}%
 \label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_load-the-library}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_load-the-library}%
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26475}{}\doxysection{\texorpdfstring{Install and load the library}{Install and load the library}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26475}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_import-web-vitals-from-npm}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_import-web-vitals-from-npm}%
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26476}{}\doxysubsection{\texorpdfstring{From npm}{From npm}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26476}
...
{\itshape {\bfseries{Note\+:}} If you\textquotesingle{}re not using npm, you can still load {\ttfamily web-\/vitals} via {\ttfamily \texorpdfstring{$<$}{<}script\texorpdfstring{$>$}{>}} tags from a CDN like \href{https://unpkg.com}{\texttt{ unpkg.\+com}}. See the \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_load-web-vitals-from-a-cdn}{load \`{}web-\/vitals\`{} from a CDN} usage example below for details.}
...
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_how-to-use-the-polyfill}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_how-to-use-the-polyfill}%
...
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_load-web-vitals-from-a-cdn}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_load-web-vitals-from-a-cdn}%
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26477}{}\doxysubsection{\texorpdfstring{From a CDN}{From a CDN}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26477}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26478}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26478}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26479}{}\doxysubsection{\texorpdfstring{Basic usage}{Basic usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26479}
...
{\itshape {\bfseries{Warning\+:}} do not call any of the Web Vitals functions (e.\+g. {\ttfamily get\+CLS()}, {\ttfamily get\+FID()}, {\ttfamily get\+LCP()}) more than once per page load. Each of these functions creates a {\ttfamily Performance\+Observer} instance and registers event listeners for the lifetime of the page. While the overhead of calling these functions once is negligible, calling them repeatedly on the same page may eventually result in a memory leak.}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26480}{}\doxysubsection{\texorpdfstring{Report the value on every change}{Report the value on every change}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26480}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26481}{}\doxysubsection{\texorpdfstring{Report only the delta of changes}{Report only the delta of changes}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26481}
...
In addition to using the {\ttfamily id} field to group multiple deltas for the same metric, it can also be used to differentiate different metrics reported on the same page. For example, after a back/forward cache restore, a new metric object is created with a new {\ttfamily id} (since back/forward cache restores are considered separate page visits).\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26482}{}\doxysubsection{\texorpdfstring{Send the results to an analytics endpoint}{Send the results to an analytics endpoint}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26482}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26483}{}\doxysubsection{\texorpdfstring{Send the results to Google Analytics}{Send the results to Google Analytics}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26483}
...
In order to use the \href{https://github.com/GoogleChromeLabs/web-vitals-report}{\texttt{ Web Vitals Report}} (or build your own custom reports using the API) you need to send your data to Google Analytics following one of the examples outlined below\+:\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26484}{}\doxysubsubsection{\texorpdfstring{Using {\ttfamily analytics.\+js}}{Using {\ttfamily analytics.\+js}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26484}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26485}{}\doxysubsubsection{\texorpdfstring{Using {\ttfamily gtag.\+js} (Universal Analytics)}{Using {\ttfamily gtag.\+js} (Universal Analytics)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26485}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26486}{}\doxysubsubsection{\texorpdfstring{Using {\ttfamily gtag.\+js} (Google Analytics 4)}{Using {\ttfamily gtag.\+js} (Google Analytics 4)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26486}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26487}{}\doxysubsection{\texorpdfstring{Send the results to Google Tag Manager}{Send the results to Google Tag Manager}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26487}
...
For full installation and usage instructions, see Simo\textquotesingle{}s post\+: \href{https://www.simoahava.com/analytics/track-core-web-vitals-in-ga4-with-google-tag-manager/}{\texttt{ Track Core Web Vitals in GA4 with Google Tag Manager}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26488}{}\doxysubsection{\texorpdfstring{Batch multiple reports together}{Batch multiple reports together}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26488}
...
{\itshape {\bfseries{Note\+:}} see \href{https://developers.google.com/web/updates/2018/07/page-lifecycle-api\#legacy-lifecycle-apis-to-avoid}{\texttt{ the Page Lifecycle guide}} for an explanation of why {\ttfamily visibilitychange} and {\ttfamily pagehide} are recommended over events like {\ttfamily beforeunload} and {\ttfamily unload}.}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26489}{}\doxysection{\texorpdfstring{Bundle versions}{Bundle versions}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26489}
...
\end{longtabu}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26490}{}\doxysubsection{\texorpdfstring{Which bundle is right for you?}{Which bundle is right for you?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26490}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26491}{}\doxysubsection{\texorpdfstring{How the polyfill works}{How the polyfill works}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26491}
...
The "{}standard"{} version of the {\ttfamily web-\/vitals} library includes some of the same logic found in {\ttfamily polyfill.\+js}. To avoid duplicating that code when using the "{}base+polyfill"{} version, the {\ttfamily web-\/vitals.\+base.\+js} bundle does not include any polyfill logic, instead it coordinates with the code in {\ttfamily polyfill.\+js}, which is why the two scripts must be used together.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26492}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26492}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26493}{}\doxysubsection{\texorpdfstring{Types\+:}{Types\+:}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26493}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26494}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Metric}}{{\ttfamily Metric}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26494}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26495}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Report\+Handler}}{{\ttfamily Report\+Handler}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26495}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26496}{}\doxysubsubsection{\texorpdfstring{{\ttfamily First\+Input\+Polyfill\+Entry}}{{\ttfamily First\+Input\+Polyfill\+Entry}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26496}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26497}{}\doxysubsubsection{\texorpdfstring{{\ttfamily First\+Input\+Polyfill\+Callback}}{{\ttfamily First\+Input\+Polyfill\+Callback}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26497}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26498}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Navigation\+Timing\+Polyfill\+Entry}}{{\ttfamily Navigation\+Timing\+Polyfill\+Entry}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26498}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26499}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Web\+Vitals\+Global}}{{\ttfamily Web\+Vitals\+Global}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26499}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26500}{}\doxysubsection{\texorpdfstring{Functions\+:}{Functions\+:}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26500}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26501}{}\doxysubsubsection{\texorpdfstring{{\ttfamily get\+CLS()}}{{\ttfamily get\+CLS()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26501}
...
{\itshape {\bfseries{Important\+:}} unlike other metrics, CLS continues to monitor changes for the entire lifespan of the page---including if the user returns to the page after it\textquotesingle{}s been hidden/backgrounded. However, since browsers often \href{https://developers.google.com/web/updates/2018/07/page-lifecycle-api\#advice-hidden}{\texttt{ will not fire additional callbacks once the user has backgrounded a page}}, {\ttfamily on\+Report} is always called when the page\textquotesingle{}s visibility state changes to hidden. As a result, the {\ttfamily on\+Report} function might be called multiple times during the same page load (see Reporting only the delta of changes for how to manage this).}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26502}{}\doxysubsubsection{\texorpdfstring{{\ttfamily get\+FCP()}}{{\ttfamily get\+FCP()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26502}
...
Calculates the \href{https://web.dev/fcp/}{\texttt{ FCP}} value for the current page and calls the {\ttfamily on\+Report} function once the value is ready, along with the relevant {\ttfamily paint} performance entry used to determine the value. The reported value is a \href{https://developer.mozilla.org/en-US/docs/Web/API/DOMHighResTimeStamp}{\texttt{ {\ttfamily DOMHigh\+Res\+Time\+Stamp}}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26503}{}\doxysubsubsection{\texorpdfstring{{\ttfamily get\+FID()}}{{\ttfamily get\+FID()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26503}
...
{\itshape {\bfseries{Important\+:}} since FID is only reported after the user interacts with the page, it\textquotesingle{}s possible that it will not be reported for some page loads.}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26504}{}\doxysubsubsection{\texorpdfstring{{\ttfamily get\+LCP()}}{{\ttfamily get\+LCP()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26504}
...
If the {\ttfamily report\+All\+Changes} param is {\ttfamily true}, the {\ttfamily on\+Report} function will be called any time a new {\ttfamily largest-\/contentful-\/paint} performance entry is dispatched, or once the final value of the metric has been determined.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26505}{}\doxysubsubsection{\texorpdfstring{{\ttfamily get\+TTFB()}}{{\ttfamily get\+TTFB()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26505}
...
\item {\ttfamily get\+FID()}\+: Chromium, Firefox, Safari, Internet Explorer (with the \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_how-to-use-the-polyfill}{polyfill})
\item {\ttfamily get\+LCP()}\+: Chromium
\item {\ttfamily get\+TTFB()}\+: Chromium, Firefox, Safari, Internet Explorer
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26507}{}\doxysection{\texorpdfstring{Limitations}{Limitations}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26507}
...
{\itshape {\bfseries{Note\+:}} given the lack of iframe support, the {\ttfamily get\+CLS()} function technically measures \href{https://github.com/wicg/layout-instability\#cumulative-scores}{\texttt{ DCLS}} (Document Cumulative Layout Shift) rather than CLS, if the page includes iframes).}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26508}{}\doxysection{\texorpdfstring{Development}{Development}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26508}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26509}{}\doxysubsection{\texorpdfstring{Building the code}{Building the code}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26509}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26510}{}\doxysubsection{\texorpdfstring{Running the tests}{Running the tests}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26510}
...
You\textquotesingle{}ll likely want to combine this with {\ttfamily npm run watch} to ensure any changes you make are transpiled and rebuilt.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26511}{}\doxysection{\texorpdfstring{Integrations}{Integrations}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26511}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26512}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2web-vitals_2_r_e_a_d_m_e_autotoc_md26512}
