\chapter{regexpu-\/core \texorpdfstring{$<$}{<}a href="{}https\+://github.\+com/mathiasbynens/regexpu-\/core/actions?query=workflow\%3\+Arun-\/checks"{} \texorpdfstring{$>$}{>}\texorpdfstring{$<$}{<}img src="{}https\+://github.\+com/mathiasbynens/regexpu-\/core/workflows/run-\/checks/badge.\+svg"{} alt="{}\+Build status"{}/\texorpdfstring{$>$}{>}\texorpdfstring{$<$}{<}/a\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}a href="{}https\+://www.\+npmjs.\+com/package/regexpu-\/core"{} \texorpdfstring{$>$}{>}\texorpdfstring{$<$}{<}img src="{}https\+://img.\+shields.\+io/npm/v/regexpu-\/core"{} alt="{}regexpu-\/core on npm"{}/\texorpdfstring{$>$}{>}\texorpdfstring{$<$}{<}/a\texorpdfstring{$>$}{>}}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e}\index{regexpu-\/core $<$a href="{}https://github.com/mathiasbynens/regexpu-\/core/actions?query=workflow\%3Arun-\/checks"{} $>$$<$img src="{}https://github.com/mathiasbynens/regexpu-\/core/workflows/run-\/checks/badge.svg"{} alt="{}Build status"{}/$>$$<$/a$>$ $<$a href="{}https://www.npmjs.com/package/regexpu-\/core"{} $>$$<$img src="{}https://img.shields.io/npm/v/regexpu-\/core"{} alt="{}regexpu-\/core on npm"{}/$>$$<$/a$>$@{regexpu-\/core $<$a href=""https://github.com/mathiasbynens/regexpu-\/core/actions?query=workflow\%3Arun-\/checks"" $>$$<$img src=""https://github.com/mathiasbynens/regexpu-\/core/workflows/run-\/checks/badge.svg"" alt=""Build status""/$>$$<$/a$>$ $<$a href=""https://www.npmjs.com/package/regexpu-\/core"" $>$$<$img src=""https://img.shields.io/npm/v/regexpu-\/core"" alt=""regexpu-\/core on npm""/$>$$<$/a$>$}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20520}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20520}%
...
{\itshape regexpu-\/core} contains \+\_\+regexpu\+\_\+’s core functionality, i.\+e. {\ttfamily rewrite\+Pattern(pattern, flag)}, which enables rewriting regular expressions that make use of \href{https://mathiasbynens.be/notes/es6-unicode-regex}{\texttt{ the ES2015 {\ttfamily u} flag}} into equivalent ES5-\/compatible regular expression patterns.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20521}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20521}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20522}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20522}
This module exports a single function named {\ttfamily rewrite\+Pattern}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20523}{}\doxysubsection{\texorpdfstring{{\ttfamily rewrite\+Pattern(pattern, flags, options)}}{{\ttfamily rewrite\+Pattern(pattern, flags, options)}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20523}
...
The optional {\ttfamily options} argument recognizes the following properties\+:\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20524}{}\doxysubsubsection{\texorpdfstring{Stable regular expression features}{Stable regular expression features}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20524}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20525}{}\doxysubsubsection{\texorpdfstring{Experimental regular expression features}{Experimental regular expression features}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20525}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20526}{}\doxysubsubsection{\texorpdfstring{Miscellaneous options}{Miscellaneous options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20526}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20527}{}\doxysubsection{\texorpdfstring{Caveats}{Caveats}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20527}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20528}{}\doxysection{\texorpdfstring{For maintainers}{For maintainers}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20528}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20529}{}\doxysubsection{\texorpdfstring{How to publish a new release}{How to publish a new release}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20529}
...
\end{DoxyEnumerate}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20530}{}\doxysection{\texorpdfstring{Author}{Author}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20530}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20531}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2regexpu-core_2_r_e_a_d_m_e_autotoc_md20531}
