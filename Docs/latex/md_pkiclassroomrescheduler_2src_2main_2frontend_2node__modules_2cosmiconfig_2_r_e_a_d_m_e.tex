\chapter{cosmiconfig}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e}\index{cosmiconfig@{cosmiconfig}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7767}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7767}%
...
Cosmiconfig continues to search up the directory tree, checking each of these places in each directory, until it finds some acceptable configuration (or hits the home directory).\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7768}{}\doxysection{\texorpdfstring{Table of contents}{Table of contents}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7768}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7769}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7769}
...
Tested in Node 10+.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7770}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7770}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7771}{}\doxysection{\texorpdfstring{Result}{Result}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7771}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7772}{}\doxysection{\texorpdfstring{Asynchronous API}{Asynchronous API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7772}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7773}{}\doxysubsection{\texorpdfstring{cosmiconfig()}{cosmiconfig()}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7773}
...
Creates a cosmiconfig instance ("{}explorer"{}) configured according to the arguments, and initializes its caches.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7774}{}\doxysubsubsection{\texorpdfstring{module\+Name}{module\+Name}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7774}
...
\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}\`{}cosmiconfig\+Options\`{} are documented below.\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} You may not need them, and should first read about the functions you\textquotesingle{}ll use.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7775}{}\doxysubsection{\texorpdfstring{explorer.\+search()}{explorer.\+search()}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7775}
...
{\bfseries{The search process is highly customizable.}} Use the cosmiconfig options \`{}search\+Places\`{} and \`{}loaders\`{} to precisely define where you want to look for configurations and how you want to load them.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7776}{}\doxysubsubsection{\texorpdfstring{search\+From}{search\+From}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7776}
Type\+: {\ttfamily string}. Default\+: {\ttfamily process.\+cwd()}.

A filename. \`{}search()\`{} will start its search here.

If the value is a directory, that\textquotesingle{}s where the search starts. If it\textquotesingle{}s a file, the search starts in that file\textquotesingle{}s directory.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7777}{}\doxysubsection{\texorpdfstring{explorer.\+load()}{explorer.\+load()}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7777}
...
You can do the same thing synchronously with \`{}explorer\+Sync.load()\`{}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7778}{}\doxysubsection{\texorpdfstring{explorer.\+clear\+Load\+Cache()}{explorer.\+clear\+Load\+Cache()}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7778}
Clears the cache used in \`{}load()\`{}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7779}{}\doxysubsection{\texorpdfstring{explorer.\+clear\+Search\+Cache()}{explorer.\+clear\+Search\+Cache()}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7779}
Clears the cache used in \`{}search()\`{}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7780}{}\doxysubsection{\texorpdfstring{explorer.\+clear\+Caches()}{explorer.\+clear\+Caches()}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7780}
Performs both \`{}clear\+Load\+Cache()\`{} and \`{}clear\+Search\+Cache()\`{}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7781}{}\doxysection{\texorpdfstring{Synchronous API}{Synchronous API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7781}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7782}{}\doxysubsection{\texorpdfstring{cosmiconfig\+Sync()}{cosmiconfig\+Sync()}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7782}
...
See \`{}cosmiconfig()\`{}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7783}{}\doxysubsection{\texorpdfstring{explorer\+Sync.\+search()}{explorer\+Sync.\+search()}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7783}
...
Returns a result or {\ttfamily null}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7784}{}\doxysubsection{\texorpdfstring{explorer\+Sync.\+load()}{explorer\+Sync.\+load()}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7784}
...
Returns a result.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7785}{}\doxysubsection{\texorpdfstring{explorer\+Sync.\+clear\+Load\+Cache()}{explorer\+Sync.\+clear\+Load\+Cache()}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7785}
Clears the cache used in \`{}load()\`{}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7786}{}\doxysubsection{\texorpdfstring{explorer\+Sync.\+clear\+Search\+Cache()}{explorer\+Sync.\+clear\+Search\+Cache()}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7786}
Clears the cache used in \`{}search()\`{}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7787}{}\doxysubsection{\texorpdfstring{explorer\+Sync.\+clear\+Caches()}{explorer\+Sync.\+clear\+Caches()}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7787}
Performs both \`{}clear\+Load\+Cache()\`{} and \`{}clear\+Search\+Cache()\`{}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7788}{}\doxysection{\texorpdfstring{cosmiconfig\+Options}{cosmiconfig\+Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7788}
Type\+: {\ttfamily Object}.

Possible options are documented below.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7789}{}\doxysubsection{\texorpdfstring{search\+Places}{search\+Places}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7789}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7790}{}\doxysubsection{\texorpdfstring{loaders}{loaders}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7790}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7791}{}\doxysubsection{\texorpdfstring{package\+Prop}{package\+Prop}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7791}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7792}{}\doxysubsection{\texorpdfstring{stop\+Dir}{stop\+Dir}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7792}
Type\+: {\ttfamily string}. Default\+: Absolute path to your home directory.

Directory where the search will stop.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7793}{}\doxysubsection{\texorpdfstring{cache}{cache}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7793}
Type\+: {\ttfamily boolean}. Default\+: {\ttfamily true}.

If {\ttfamily false}, no caches will be used. Read more about "{}Caching"{} below.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7794}{}\doxysubsection{\texorpdfstring{transform}{transform}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7794}
...
The reason you might use this option — instead of simply applying your transform function some other way — is that {\itshape the transformed result will be cached}. If your transformation involves additional filesystem I/O or other potentially slow processing, you can use this option to avoid repeating those steps every time a given configuration is searched or loaded.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7795}{}\doxysubsection{\texorpdfstring{ignore\+Empty\+Search\+Places}{ignore\+Empty\+Search\+Places}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7795}
Type\+: {\ttfamily boolean}. Default\+: {\ttfamily true}.
...
Why might you want to load empty configuration files? If you want to throw an error, or if an empty configuration file means something to your program.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7796}{}\doxysection{\texorpdfstring{Caching}{Caching}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7796}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7797}{}\doxysection{\texorpdfstring{Differences from \href{https://github.com/dominictarr/rc}{\texttt{ rc}}}{Differences from \href{https://github.com/dominictarr/rc}{\texttt{ rc}}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7797}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7798}{}\doxysection{\texorpdfstring{Contributing \& Development}{Contributing \& Development}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2cosmiconfig_2_r_e_a_d_m_e_autotoc_md7798}
