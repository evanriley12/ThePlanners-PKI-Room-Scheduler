...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e}\index{faye-\/websocket@{faye-\/websocket}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12088}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12088}%
...
It also provides an abstraction for handling \href{https://html.spec.whatwg.org/multipage/comms.html\#server-sent-events}{\texttt{ Event\+Source}} connections, which are one-\/way connections that allow the server to push data to the client. They are based on streaming HTTP responses and can be easier to access via proxies than Web\+Sockets.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12089}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12089}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ faye-\/websocket}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12090}{}\doxysection{\texorpdfstring{Handling Web\+Socket connections in Node}{Handling Web\+Socket connections in Node}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12090}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12091}{}\doxysection{\texorpdfstring{Using the Web\+Socket client}{Using the Web\+Socket client}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12091}
...
The {\ttfamily tls} value is an object that will be passed to \href{https://nodejs.org/api/tls.html\#tls_tls_connect_options_callback}{\texttt{ {\ttfamily tls.\+connect()}}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12092}{}\doxysection{\texorpdfstring{Subprotocol negotiation}{Subprotocol negotiation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12092}
...
If the client and server agree on a protocol, both the client-\/ and server-\/side socket objects expose the selected protocol through the {\ttfamily ws.\+protocol} property.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12093}{}\doxysection{\texorpdfstring{Protocol extensions}{Protocol extensions}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12093}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12094}{}\doxysection{\texorpdfstring{Initialization options}{Initialization options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12094}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12095}{}\doxysection{\texorpdfstring{Web\+Socket API}{Web\+Socket API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12095}
Both server-\/ and client-\/side {\ttfamily Web\+Socket} objects support the following API.


\begin{DoxyItemize}
\item \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}`on(\textquotesingle{}open', function(event) \{\}){\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} fires when the socket connection is established. Event has no attributes.}
\item {\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}}on(\textquotesingle{}message\textquotesingle{}, function(event) \{\}){\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} fires when the socket receives a message. Event has one attribute, \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}}data{\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}, which is either a}String$<$tt$>$(for   text frames) or aBuffer$<$tt$>$(for binary frames).
\item \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}on(\textquotesingle{}error\textquotesingle{}, function(event) \{\}){\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} fires when there is a protocol error due to bad data sent by the other peer. This event is purely informational, you do not need to implement error recover.}
\item {\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}}on(\textquotesingle{}close\textquotesingle{}, function(event) \{\}){\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} fires when either the client or the server closes the connection. Event has two optional attributes, \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}}code{\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} and \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}}reason{\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}, that expose the status code and message sent by the peer that closed the connection.}
\item {\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}}send(message){\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} accepts either a}String{\ttfamily or a}Buffer{\ttfamily and sends a text or binary message over the connection to the other peer.}
\item {\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}}ping(message, function() \{\}){\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} sends a ping frame with an optional message and fires the callback when a matching pong is received.}
\item {\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}}close(code, reason){\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} closes the connection, sending the given status code and reason text, both of which are optional.}
\item {\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}}version{\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} is a string containing the version of the}Web\+Socket{\ttfamily protocol the connection is using.}
\item {\ttfamily \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}}protocol\`{}\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} is a string (which may be empty) identifying the subprotocol the socket is using.
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12096}{}\doxysection{\texorpdfstring{Handling Event\+Source connections in Node}{Handling Event\+Source connections in Node}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2faye-websocket_2_r_e_a_d_m_e_autotoc_md12096}
...
\begin{DoxyItemize}
\item \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}{\ttfamily url}\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} is a string containing the URL the client used to create the Event\+Source.
\item \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}{\ttfamily last\+Event\+Id}\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} is a string containing the last event ID received by the client. You can use this when the client reconnects after a dropped connection to determine which messages need resending.
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}{\ttfamily headers}\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} is an object containing custom headers to be set on the Event\+Source response.
\item \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}{\ttfamily retry}\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} is a number that tells the client how long (in seconds) it should wait after a dropped connection before attempting to reconnect.
\item \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}{\ttfamily ping}\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} is a number that tells the server how often (in seconds) to send \textquotesingle{}ping\textquotesingle{} packets to the client to keep the connection open, to defeat timeouts set by proxies. The client will ignore these messages.
\end{DoxyItemize}
