...
\end{DoxyItemize}\hypertarget{namespaceat_autotoc_md6905}{}\doxysubsubsection{\texorpdfstring{Important\+: 4.\+0 breaking changes}{Important\+: 4.\+0 breaking changes}}\label{namespaceat_autotoc_md6905}
...
\end{DoxyItemize}\hypertarget{namespaceat_autotoc_md6906}{}\doxysubsubsection{\texorpdfstring{Constructor options}{Constructor options}}\label{namespaceat_autotoc_md6906}
...
\end{DoxyItemize}\hypertarget{namespaceat_autotoc_md6907}{}\doxysubsubsection{\texorpdfstring{Compatibility modes}{Compatibility modes}}\label{namespaceat_autotoc_md6907}
...
\end{DoxyCode}
\hypertarget{namespaceat_autotoc_md6908}{}\doxysubsubsection{\texorpdfstring{Fetch option}{Fetch option}}\label{namespaceat_autotoc_md6908}
...
Unless given, the default \href{https://github.com/clean-css/clean-css/blob/master/lib/reader/load-remote-resource.js}{\texttt{ load\+Remote\+Resource}} logic is used.\hypertarget{namespaceat_autotoc_md6909}{}\doxysubsubsection{\texorpdfstring{Formatting options}{Formatting options}}\label{namespaceat_autotoc_md6909}
...
which will add nicer spacing between at rules and blocks.\hypertarget{namespaceat_autotoc_md6910}{}\doxysubsubsection{\texorpdfstring{Inlining options}{Inlining options}}\label{namespaceat_autotoc_md6910}
...
\end{DoxyCode}
\hypertarget{namespaceat_autotoc_md6911}{}\doxysubsubsection{\texorpdfstring{Optimization levels}{Optimization levels}}\label{namespaceat_autotoc_md6911}
...
Please note that level 1 optimization options are generally safe while level 2 optimizations should be safe for most users.\hypertarget{namespaceat_autotoc_md6912}{}\doxysubsubsubsection{\texorpdfstring{Level 0 optimizations}{Level 0 optimizations}}\label{namespaceat_autotoc_md6912}
Level 0 optimizations simply means "{}no optimizations"{}. Use it when you\textquotesingle{}d like to inline imports and / or rebase URLs but skip everything else.\hypertarget{namespaceat_autotoc_md6913}{}\doxysubsubsubsection{\texorpdfstring{Level 1 optimizations}{Level 1 optimizations}}\label{namespaceat_autotoc_md6913}
...
\end{DoxyCode}
\hypertarget{namespaceat_autotoc_md6914}{}\doxysubsubsubsection{\texorpdfstring{Level 2 optimizations}{Level 2 optimizations}}\label{namespaceat_autotoc_md6914}
...
\end{DoxyCode}
\hypertarget{namespaceat_autotoc_md6915}{}\doxysubsubsection{\texorpdfstring{Plugins}{Plugins}}\label{namespaceat_autotoc_md6915}
...
There are several ways to optimize multiple files at the same time, see How to optimize multiple files?.\hypertarget{namespaceat_autotoc_md6917}{}\doxysubsubsection{\texorpdfstring{Promise interface}{Promise interface}}\label{namespaceat_autotoc_md6917}
...
\end{DoxyCode}
\hypertarget{namespaceat_autotoc_md6918}{}\doxysubsubsection{\texorpdfstring{CLI utility}{CLI utility}}\label{namespaceat_autotoc_md6918}
Clean-\/css has an associated command line utility that can be installed separately using {\ttfamily npm install clean-\/css-\/cli}. For more detailed information, please visit \href{https://github.com/clean-css/clean-css-cli}{\texttt{ https\+://github.\+com/clean-\/css/clean-\/css-\/cli}}.\hypertarget{namespaceat_autotoc_md6919}{}\doxysubsection{\texorpdfstring{FAQ}{FAQ}}\label{namespaceat_autotoc_md6919}
\hypertarget{namespaceat_autotoc_md6920}{}\doxysubsubsection{\texorpdfstring{How to optimize multiple files?}{How to optimize multiple files?}}\label{namespaceat_autotoc_md6920}
...
Important note -\/ any {\ttfamily @import} rules already present in the hash will be resolved in memory.\hypertarget{namespaceat_autotoc_md6921}{}\doxysubsubsection{\texorpdfstring{How to process multiple files without concatenating them into one output file?}{How to process multiple files without concatenating them into one output file?}}\label{namespaceat_autotoc_md6921}
...
\end{DoxyCode}
\hypertarget{namespaceat_autotoc_md6922}{}\doxysubsubsection{\texorpdfstring{How to process remote {\ttfamily @import}s correctly?}{How to process remote {\ttfamily @import}s correctly?}}\label{namespaceat_autotoc_md6922}
...
If you don\textquotesingle{}t provide a callback, then remote {\ttfamily @import}s will be left as is.\hypertarget{namespaceat_autotoc_md6923}{}\doxysubsubsection{\texorpdfstring{How to apply arbitrary transformations to CSS properties?}{How to apply arbitrary transformations to CSS properties?}}\label{namespaceat_autotoc_md6923}
Please see plugins.\hypertarget{namespaceat_autotoc_md6924}{}\doxysubsubsection{\texorpdfstring{How to specify a custom rounding precision?}{How to specify a custom rounding precision?}}\label{namespaceat_autotoc_md6924}
...
which sets all units rounding precision to 3 digits except {\ttfamily px} unit precision of 5 digits.\hypertarget{namespaceat_autotoc_md6925}{}\doxysubsubsection{\texorpdfstring{How to optimize a stylesheet with custom {\ttfamily rpx} units?}{How to optimize a stylesheet with custom {\ttfamily rpx} units?}}\label{namespaceat_autotoc_md6925}
...
\end{DoxyCode}
\hypertarget{namespaceat_autotoc_md6926}{}\doxysubsubsection{\texorpdfstring{How to keep a CSS fragment intact?}{How to keep a CSS fragment intact?}}\label{namespaceat_autotoc_md6926}
...
\end{DoxyCode}
\hypertarget{namespaceat_autotoc_md6927}{}\doxysubsubsection{\texorpdfstring{How to preserve a comment block?}{How to preserve a comment block?}}\label{namespaceat_autotoc_md6927}
...
\end{DoxyCode}
\hypertarget{namespaceat_autotoc_md6928}{}\doxysubsubsection{\texorpdfstring{How to rebase relative image URLs?}{How to rebase relative image URLs?}}\label{namespaceat_autotoc_md6928}
...
\end{DoxyItemize}\hypertarget{namespaceat_autotoc_md6929}{}\doxysubsubsection{\texorpdfstring{How to work with source maps?}{How to work with source maps?}}\label{namespaceat_autotoc_md6929}
...
\end{DoxyCode}
\hypertarget{namespaceat_autotoc_md6930}{}\doxysubsubsection{\texorpdfstring{How to apply level 1 \& 2 optimizations at the same time?}{How to apply level 1 \& 2 optimizations at the same time?}}\label{namespaceat_autotoc_md6930}
...
will apply level 1 optimizations, except url normalization, and default level 2 optimizations with rule restructuring.\hypertarget{namespaceat_autotoc_md6931}{}\doxysubsubsection{\texorpdfstring{What level 2 optimizations do?}{What level 2 optimizations do?}}\label{namespaceat_autotoc_md6931}
...
\end{DoxyItemize}\hypertarget{namespaceat_autotoc_md6932}{}\doxysubsubsection{\texorpdfstring{What errors and warnings are?}{What errors and warnings are?}}\label{namespaceat_autotoc_md6932}
...
\end{DoxyCode}
 \hypertarget{namespaceat_autotoc_md6933}{}\doxysubsubsection{\texorpdfstring{Clean-\/css for Gulp}{Clean-\/css for Gulp}}\label{namespaceat_autotoc_md6933}
...
\end{DoxyCode}
\hypertarget{namespaceat_autotoc_md6934}{}\doxysubsubsection{\texorpdfstring{How to use clean-\/css with build tools?}{How to use clean-\/css with build tools?}}\label{namespaceat_autotoc_md6934}
...
\end{DoxyItemize}\hypertarget{namespaceat_autotoc_md6935}{}\doxysubsubsection{\texorpdfstring{How to use clean-\/css from web browser?}{How to use clean-\/css from web browser?}}\label{namespaceat_autotoc_md6935}
...
\end{DoxyItemize}\hypertarget{namespaceat_autotoc_md6936}{}\doxysubsection{\texorpdfstring{Contributing}{Contributing}}\label{namespaceat_autotoc_md6936}
See \href{https://github.com/clean-css/clean-css/blob/master/CONTRIBUTING.md}{\texttt{ CONTRIBUTING.\+md}}.\hypertarget{namespaceat_autotoc_md6937}{}\doxysubsubsection{\texorpdfstring{How to get started?}{How to get started?}}\label{namespaceat_autotoc_md6937}
...
\end{DoxyCode}
\hypertarget{namespaceat_autotoc_md6938}{}\doxysubsection{\texorpdfstring{Acknowledgments}{Acknowledgments}}\label{namespaceat_autotoc_md6938}
...
\end{DoxyItemize}\hypertarget{namespaceat_autotoc_md6939}{}\doxysubsection{\texorpdfstring{License}{License}}\label{namespaceat_autotoc_md6939}
