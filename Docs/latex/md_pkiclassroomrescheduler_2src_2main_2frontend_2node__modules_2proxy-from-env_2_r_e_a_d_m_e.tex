...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e}\index{proxy-\/from-\/env@{proxy-\/from-\/env}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e_autotoc_md19957}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e_autotoc_md19957}%
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e_autotoc_md19958}{}\doxysection{\texorpdfstring{Example}{Example}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e_autotoc_md19958}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e_autotoc_md19959}{}\doxysection{\texorpdfstring{Environment variables}{Environment variables}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e_autotoc_md19959}
The environment variables can be specified in lowercase or uppercase, with the lowercase name having precedence over the uppercase variant. A variable that is not set has the same meaning as a variable that is set but has no value.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e_autotoc_md19960}{}\doxysubsection{\texorpdfstring{NO\+\_\+\+PROXY}{NO\+\_\+\+PROXY}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e_autotoc_md19960}
...
See {\ttfamily test.\+js} for examples of what should match and what does not.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e_autotoc_md19961}{}\doxysubsection{\texorpdfstring{\texorpdfstring{$\ast$}{*}\+\_\+\+PROXY}{\texorpdfstring{$\ast$}{*}\+\_\+\+PROXY}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e_autotoc_md19961}
...
If present, {\ttfamily ALL\+\_\+\+PROXY} is used as fallback if there is no other match.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e_autotoc_md19962}{}\doxysection{\texorpdfstring{External resources}{External resources}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-from-env_2_r_e_a_d_m_e_autotoc_md19962}
