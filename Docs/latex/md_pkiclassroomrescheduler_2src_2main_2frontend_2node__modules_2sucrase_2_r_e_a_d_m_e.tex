\chapter{Sucrase}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e}\index{Sucrase@{Sucrase}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24185}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24185}%
 \href{https://github.com/alangpierce/sucrase/actions}{\texttt{ }} \href{https://www.npmjs.com/package/sucrase}{\texttt{ }} \href{https://packagephobia.now.sh/result?p=sucrase}{\texttt{ }} \mbox{[}\mbox{]}(LICENSE) \href{https://gitter.im/sucrasejs/Lobby}{\texttt{ }}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24186}{}\doxysection{\texorpdfstring{\href{https://sucrase.io}{\texttt{ Try it out}}}{\href{https://sucrase.io}{\texttt{ Try it out}}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24186}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24187}{}\doxysection{\texorpdfstring{Quick usage}{Quick usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24187}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24188}{}\doxysection{\texorpdfstring{Project overview}{Project overview}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24188}
...
Details\+: Measured on July 2022. Tools run in single-\/threaded mode without warm-\/up. See the \href{https://github.com/alangpierce/sucrase/blob/main/benchmark/benchmark.ts}{\texttt{ benchmark code}} for methodology and caveats.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24189}{}\doxysection{\texorpdfstring{Transforms}{Transforms}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24189}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24191}{}\doxysubsection{\texorpdfstring{JSX Options}{JSX Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24191}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24192}{}\doxysubsection{\texorpdfstring{Legacy Common\+JS interop}{Legacy Common\+JS interop}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24192}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24193}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24193}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24194}{}\doxysubsection{\texorpdfstring{Tool integrations}{Tool integrations}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24194}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24195}{}\doxysubsection{\texorpdfstring{Usage in Node}{Usage in Node}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24195}
...
Options can be passed to the require hook via a {\ttfamily SUCRASE\+\_\+\+OPTIONS} environment variable holding a JSON string of options.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24196}{}\doxysubsection{\texorpdfstring{Compiling a project to JS}{Compiling a project to JS}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24196}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24197}{}\doxysubsection{\texorpdfstring{Usage from code}{Usage from code}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24197}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24198}{}\doxysection{\texorpdfstring{What Sucrase is not}{What Sucrase is not}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24198}
...
See the Project Vision document for more details on the philosophy behind Sucrase.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24199}{}\doxysection{\texorpdfstring{Motivation}{Motivation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24199}
...
Because Sucrase works on a lower level and uses a custom parser for its use case, it is much faster than Babel.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24200}{}\doxysection{\texorpdfstring{Contributing}{Contributing}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24200}
Contributions are welcome, whether they be bug reports, PRs, docs, tests, or anything else! Please take a look through the Contributing Guide to learn how to get started.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24201}{}\doxysection{\texorpdfstring{License and attribution}{License and attribution}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24201}
Sucrase is MIT-\/licensed. A large part of Sucrase is based on a fork of the \href{https://github.com/babel/babel/tree/main/packages/babel-parser}{\texttt{ Babel parser}}, which is also MIT-\/licensed.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24202}{}\doxysection{\texorpdfstring{Why the name?}{Why the name?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2sucrase_2_r_e_a_d_m_e_autotoc_md24202}
