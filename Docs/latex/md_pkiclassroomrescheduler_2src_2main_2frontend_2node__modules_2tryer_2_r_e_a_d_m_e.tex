\chapter{tryer}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e}\index{tryer@{tryer}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25637}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25637}%
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25638}{}\doxysection{\texorpdfstring{Say what?}{Say what?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25638}
...
Additionally, it allows you to easily specify retry intervals and limits, so that your code doesn\textquotesingle{}t hog the CPU. It also supports exponential backoff of retry intervals, which can be useful when handling indefinite error states such as network failure.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25639}{}\doxysection{\texorpdfstring{What size is it?}{What size is it?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25639}
5.\+6 kb unminified with comments, 1.\+1 kb minified, 0.\+5 kb minified + gzipped.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25640}{}\doxysection{\texorpdfstring{How do I install it?}{How do I install it?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25640}
Via npm\+:
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25641}{}\doxysection{\texorpdfstring{How do I use it?}{How do I use it?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25641}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25642}{}\doxysubsection{\texorpdfstring{Loading the library}{Loading the library}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25642}
...
If you are including {\ttfamily tryer} with an HTML {\ttfamily \texorpdfstring{$<$}{<}script\texorpdfstring{$>$}{>}} tag, or neither of the above environments are detected, it will be exported globally as {\ttfamily tryer}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25643}{}\doxysubsection{\texorpdfstring{Calling the exported function}{Calling the exported function}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25643}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25644}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25644}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25645}{}\doxysection{\texorpdfstring{How do I set up the dev environment?}{How do I set up the dev environment?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25645}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25646}{}\doxysection{\texorpdfstring{What license is it released under?}{What license is it released under?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2tryer_2_r_e_a_d_m_e_autotoc_md25646}
