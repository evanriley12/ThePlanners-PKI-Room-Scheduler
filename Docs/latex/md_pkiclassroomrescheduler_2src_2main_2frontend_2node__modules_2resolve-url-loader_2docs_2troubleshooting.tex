...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2troubleshooting}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2troubleshooting}\index{Troubleshooting@{Troubleshooting}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2troubleshooting_autotoc_md20660}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2troubleshooting_autotoc_md20660}%
...
\item Read and understand the detail on \doxysectlink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2how-it-works}{how the loader works}{0}.
...
I\textquotesingle{}m happy this loader helps so many people. Open-\/source is provided as-\/is and I\textquotesingle{}m currently {\bfseries{not}} \href{https://en.wikipedia.org/wiki/Eating_your_own_dog_food}{\texttt{ dogfooding}} this loader in my own work, so please try not project your frustrations. There are some really great people who follow this project who can help.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2troubleshooting_autotoc_md20661}{}\doxysection{\texorpdfstring{Known issues}{Known issues}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2troubleshooting_autotoc_md20661}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2troubleshooting_autotoc_md20662}{}\doxysubsection{\texorpdfstring{Support for {\ttfamily image-\/set()}}{Support for {\ttfamily image-\/set()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2troubleshooting_autotoc_md20662}
Right now this loader only rewrites {\ttfamily url()} statements.

If you need other statements processed, such as {\ttfamily image-\/set()}, then please upvote \href{issues/119}{\texttt{ issue \#119}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2troubleshooting_autotoc_md20663}{}\doxysubsection{\texorpdfstring{Absolute URIs}{Absolute URIs}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2troubleshooting_autotoc_md20663}
...
Also it be useful to process absolute URIs if you have a custom {\ttfamily join} function and want to process all the paths. Although this is perhaps better done with some separate {\ttfamily postcss} plugin.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2troubleshooting_autotoc_md20664}{}\doxysubsection{\texorpdfstring{Windows line breaks}{Windows line breaks}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve-url-loader_2docs_2troubleshooting_autotoc_md20664}
