...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e}\index{http-\/proxy-\/middleware@{http-\/proxy-\/middleware}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13771}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13771}%
...
Powered by the popular Nodejitsu \href{https://github.com/nodejitsu/node-http-proxy}{\texttt{ {\ttfamily http-\/proxy}}}. \href{https://github.com/nodejitsu/node-http-proxy}{\texttt{ }}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13772}{}\doxysection{\texorpdfstring{⚠️ Note }{⚠️ Note }}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13772}
...
If you\textquotesingle{}re looking for v0.\+x documentation. Go to\+: \href{https://github.com/chimurai/http-proxy-middleware/tree/v0.21.0\#readme}{\texttt{ https\+://github.\+com/chimurai/http-\/proxy-\/middleware/tree/v0.\+21.\+0\#readme}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13773}{}\doxysection{\texorpdfstring{TL;DR }{TL;DR }}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13773}
...
{\itshape All} {\ttfamily http-\/proxy} \href{https://github.com/nodejitsu/node-http-proxy\#options}{\texttt{ options}} can be used, along with some extra {\ttfamily http-\/proxy-\/middleware} \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2node-forge_2_r_e_a_d_m_e_options}{options}.

\+:bulb\+: {\bfseries{Tip\+:}} Set the option {\ttfamily change\+Origin} to {\ttfamily true} for \href{http://en.wikipedia.org/wiki/Virtual_hosting\#Name-based}{\texttt{ name-\/based virtual hosted sites}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13774}{}\doxysection{\texorpdfstring{Table of Contents }{Table of Contents }}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13774}
...
\item Changelog
\item License
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13775}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13775}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ -\/-\/save-\/dev\ http-\/proxy-\/middleware}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13776}{}\doxysection{\texorpdfstring{Core concept}{Core concept}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13776}
Proxy middleware configuration.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13777}{}\doxysubsubsection{\texorpdfstring{create\+Proxy\+Middleware(\mbox{[}context,\mbox{]} config)}{create\+Proxy\+Middleware(\mbox{[}context,\mbox{]} config)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13777}
...
(full list of \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2node-forge_2_r_e_a_d_m_e_options}{\`{}http-\/proxy-\/middleware\`{} configuration options})\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13778}{}\doxysubsubsection{\texorpdfstring{create\+Proxy\+Middleware(uri \mbox{[}, config\mbox{]})}{create\+Proxy\+Middleware(uri \mbox{[}, config\mbox{]})}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13778}
...
More about the shorthand configuration.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13779}{}\doxysection{\texorpdfstring{Example}{Example}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13779}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13780}{}\doxysection{\texorpdfstring{Context matching}{Context matching}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13780}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13781}{}\doxysection{\texorpdfstring{Options}{Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13781}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13782}{}\doxysubsection{\texorpdfstring{http-\/proxy-\/middleware options}{http-\/proxy-\/middleware options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13782}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13783}{}\doxysubsection{\texorpdfstring{http-\/proxy events}{http-\/proxy events}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13783}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13784}{}\doxysubsection{\texorpdfstring{http-\/proxy options}{http-\/proxy options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13784}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13785}{}\doxysection{\texorpdfstring{Shorthand}{Shorthand}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13785}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13786}{}\doxysubsection{\texorpdfstring{app.\+use(path, proxy)}{app.\+use(path, proxy)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13786}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13787}{}\doxysection{\texorpdfstring{Web\+Socket}{Web\+Socket}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13787}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13788}{}\doxysubsection{\texorpdfstring{External Web\+Socket upgrade}{External Web\+Socket upgrade}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13788}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13789}{}\doxysection{\texorpdfstring{Intercept and manipulate requests}{Intercept and manipulate requests}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13789}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13790}{}\doxysection{\texorpdfstring{Intercept and manipulate responses}{Intercept and manipulate responses}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13790}
...
Check out \href{https://github.com/chimurai/http-proxy-middleware/blob/master/recipes/response-interceptor.md\#readme}{\texttt{ interception recipes}} for more examples.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13791}{}\doxysection{\texorpdfstring{Working examples}{Working examples}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13791}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13792}{}\doxysection{\texorpdfstring{Recipes}{Recipes}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13792}
View the \href{https://github.com/chimurai/http-proxy-middleware/tree/master/recipes}{\texttt{ recipes}} for common use cases.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13793}{}\doxysection{\texorpdfstring{Compatible servers}{Compatible servers}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13793}
...
Sample implementations can be found in the \href{https://github.com/chimurai/http-proxy-middleware/tree/master/recipes/servers.md}{\texttt{ server recipes}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13794}{}\doxysection{\texorpdfstring{Tests}{Tests}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13794}
Run the test suite\+:
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13795}{}\doxysection{\texorpdfstring{Changelog}{Changelog}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13795}

\begin{DoxyItemize}
\item \href{https://github.com/chimurai/http-proxy-middleware/blob/master/CHANGELOG.md}{\texttt{ View changelog}}
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13796}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2http-proxy-middleware_2_r_e_a_d_m_e_autotoc_md13796}
The MIT License (MIT)
