\chapter{lru-\/cache}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e}\index{lru-\/cache@{lru-\/cache}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17966}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17966}%
...
If you put more stuff in the cache, then less recently used items will fall out. That\textquotesingle{}s what an LRU cache is.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17969}{}\doxysection{\texorpdfstring{{\ttfamily class LRUCache\texorpdfstring{$<$}{<}K, V, FC = unknown\texorpdfstring{$>$}{>}(options)}}{{\ttfamily class LRUCache\texorpdfstring{$<$}{<}K, V, FC = unknown\texorpdfstring{$>$}{>}(options)}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17969}
...
The {\ttfamily FC} ("{}fetch context"{}) generic type defaults to {\ttfamily unknown}. If set to a value other than {\ttfamily void} or {\ttfamily undefined}, then any calls to {\ttfamily cache.\+fetch()} {\itshape must} provide a {\ttfamily context} option matching the {\ttfamily FC} type. If {\ttfamily FC} is set to {\ttfamily void} or {\ttfamily undefined}, then {\ttfamily cache.\+fetch()} {\itshape must not} provide a {\ttfamily context} option. See the documentation on {\ttfamily async fetch()} below.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17970}{}\doxysection{\texorpdfstring{Options}{Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17970}
...
Some options are marked read-\/only because changing them after instantiation is not safe. Changing any of the other options will of course only have an effect on subsequent method calls.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17971}{}\doxysubsection{\texorpdfstring{{\ttfamily max} (read only)}{{\ttfamily max} (read only)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17971}
...
{\bfseries{It is strongly recommended to set a {\ttfamily max} to prevent unbounded growth of the cache.}} See "{}\+Storage Bounds Safety"{} below.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17972}{}\doxysubsection{\texorpdfstring{{\ttfamily max\+Size} (read only)}{{\ttfamily max\+Size} (read only)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17972}
...
Even if size tracking is enabled, {\bfseries{it is strongly recommended to set a {\ttfamily max} to prevent unbounded growth of the cache.}} See "{}\+Storage Bounds Safety"{} below.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17973}{}\doxysubsection{\texorpdfstring{{\ttfamily max\+Entry\+Size}}{{\ttfamily max\+Entry\+Size}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17973}
...
Optional, must be a positive integer if provided. Defaults to the value of {\ttfamily max\+Size} if provided.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17974}{}\doxysubsection{\texorpdfstring{{\ttfamily size\+Calculation}}{{\ttfamily size\+Calculation}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17974}
...
If the {\ttfamily size} (or return value of {\ttfamily size\+Calculation}) for a given entry is greater than {\ttfamily max\+Entry\+Size}, then the item will not be added to the cache.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17975}{}\doxysubsection{\texorpdfstring{{\ttfamily fetch\+Method} (read only)}{{\ttfamily fetch\+Method} (read only)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17975}
...
For example, a DNS cache may update the TTL based on the value returned from a remote DNS server by changing {\ttfamily options.\+ttl} in the {\ttfamily fetch\+Method}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17976}{}\doxysubsection{\texorpdfstring{{\ttfamily no\+Delete\+On\+Fetch\+Rejection}}{{\ttfamily no\+Delete\+On\+Fetch\+Rejection}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17976}
...
This may be set in calls to {\ttfamily fetch()}, or defaulted on the constructor, or overridden by modifying the options object in the {\ttfamily fetch\+Method}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17977}{}\doxysubsection{\texorpdfstring{{\ttfamily allow\+Stale\+On\+Fetch\+Rejection}}{{\ttfamily allow\+Stale\+On\+Fetch\+Rejection}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17977}
...
This may be set in calls to {\ttfamily fetch()}, or defaulted on the constructor, or overridden by modifying the options object in the {\ttfamily fetch\+Method}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17978}{}\doxysubsection{\texorpdfstring{{\ttfamily allow\+Stale\+On\+Fetch\+Abort}}{{\ttfamily allow\+Stale\+On\+Fetch\+Abort}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17978}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17979}{}\doxysubsection{\texorpdfstring{{\ttfamily ignore\+Fetch\+Abort}}{{\ttfamily ignore\+Fetch\+Abort}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17979}
...
This may be overridden on the {\ttfamily fetch()} call or in the {\ttfamily fetch\+Method} itself.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17980}{}\doxysubsection{\texorpdfstring{{\ttfamily dispose} (read only)}{{\ttfamily dispose} (read only)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17980}
...
Optional, must be a function.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17981}{}\doxysubsection{\texorpdfstring{{\ttfamily dispose\+After} (read only)}{{\ttfamily dispose\+After} (read only)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17981}
...
The {\ttfamily dispose\+After()} method is {\itshape not} called for canceled calls to {\ttfamily fetch\+Method()}. If you wish to handle evictions, overwrites, and deletes of in-\/flight asynchronous fetches, you must use the {\ttfamily Abort\+Signal} provided.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17982}{}\doxysubsection{\texorpdfstring{{\ttfamily no\+Dispose\+On\+Set}}{{\ttfamily no\+Dispose\+On\+Set}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17982}
...
Boolean, default {\ttfamily false}. Only relevant if {\ttfamily dispose} or {\ttfamily dispose\+After} options are set.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17983}{}\doxysubsection{\texorpdfstring{{\ttfamily ttl}}{{\ttfamily ttl}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17983}
...
Boolean, default false.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17985}{}\doxysubsection{\texorpdfstring{{\ttfamily ttl\+Resolution}}{{\ttfamily ttl\+Resolution}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17985}
...
Note that setting this to a higher value {\itshape will} improve performance somewhat while using ttl tracking, albeit at the expense of keeping stale items around a bit longer than intended.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17986}{}\doxysubsection{\texorpdfstring{{\ttfamily ttl\+Autopurge}}{{\ttfamily ttl\+Autopurge}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17986}
...
Boolean, default {\ttfamily false}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17987}{}\doxysubsection{\texorpdfstring{{\ttfamily allow\+Stale}}{{\ttfamily allow\+Stale}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17987}
...
Boolean, default false, only relevant if {\ttfamily ttl} is set.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17988}{}\doxysubsection{\texorpdfstring{{\ttfamily no\+Delete\+On\+Stale\+Get}}{{\ttfamily no\+Delete\+On\+Stale\+Get}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17988}
...
Boolean, default false, only relevant if {\ttfamily ttl} is set.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17989}{}\doxysubsection{\texorpdfstring{{\ttfamily update\+Age\+On\+Get}}{{\ttfamily update\+Age\+On\+Get}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17989}
...
Boolean, default false, only relevant if {\ttfamily ttl} is set.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17990}{}\doxysubsection{\texorpdfstring{{\ttfamily update\+Age\+On\+Has}}{{\ttfamily update\+Age\+On\+Has}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17990}
...
Boolean, default false, only relevant if {\ttfamily ttl} is set.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17991}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17991}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17992}{}\doxysubsection{\texorpdfstring{{\ttfamily new LRUCache\texorpdfstring{$<$}{<}K, V, FC = unknown\texorpdfstring{$>$}{>}(options)}}{{\ttfamily new LRUCache\texorpdfstring{$<$}{<}K, V, FC = unknown\texorpdfstring{$>$}{>}(options)}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17992}
...
Keys and values {\bfseries{must not}} be {\ttfamily null} or {\ttfamily undefined}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17993}{}\doxysubsection{\texorpdfstring{{\ttfamily cache.\+max}, {\ttfamily cache.\+max\+Size}, {\ttfamily cache.\+allow\+Stale},}{{\ttfamily cache.\+max}, {\ttfamily cache.\+max\+Size}, {\ttfamily cache.\+allow\+Stale},}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17993}
...
These are intended for read access only. Changing them during program operation can cause undefined behavior.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17994}{}\doxysubsection{\texorpdfstring{{\ttfamily cache.\+size}}{{\ttfamily cache.\+size}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17994}
The total number of items held in the cache at the current moment.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17995}{}\doxysubsection{\texorpdfstring{{\ttfamily cache.\+calculated\+Size}}{{\ttfamily cache.\+calculated\+Size}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17995}
The total size of items in cache when using size tracking.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17996}{}\doxysubsection{\texorpdfstring{{\ttfamily set(key, value, \mbox{[}\{ size, size\+Calculation, ttl, no\+Dispose\+On\+Set, start, status \}\mbox{]})}}{{\ttfamily set(key, value, \mbox{[}\{ size, size\+Calculation, ttl, no\+Dispose\+On\+Set, start, status \}\mbox{]})}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17996}
...
If the value is {\ttfamily undefined}, then this is an alias for {\ttfamily cache.\+delete(key)}. {\ttfamily undefined} is never stored in the cache. See {\bfseries{Storing Undefined Values}} below.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17997}{}\doxysubsection{\texorpdfstring{{\ttfamily get(key, \{ update\+Age\+On\+Get, allow\+Stale, status \} = \{\}) =\texorpdfstring{$>$}{>} value}}{{\ttfamily get(key, \{ update\+Age\+On\+Get, allow\+Stale, status \} = \{\}) =\texorpdfstring{$>$}{>} value}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17997}
...
For the usage of the {\ttfamily status} option, see {\bfseries{Status Tracking}} below.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17998}{}\doxysubsection{\texorpdfstring{{\ttfamily info(key) =\texorpdfstring{$>$}{>} Entry \texorpdfstring{$\vert$}{|} undefined}}{{\ttfamily info(key) =\texorpdfstring{$>$}{>} Entry \texorpdfstring{$\vert$}{|} undefined}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17998}
...
Note that stale values are always returned, rather than being pruned and treated as if they were not in the cache. If you wish to exclude stale entries, guard against a negative {\ttfamily ttl} value.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17999}{}\doxysubsection{\texorpdfstring{{\ttfamily async fetch(key, options = \{\}) =\texorpdfstring{$>$}{>} Promise}}{{\ttfamily async fetch(key, options = \{\}) =\texorpdfstring{$>$}{>} Promise}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md17999}
...
If a {\ttfamily signal} is passed to the {\ttfamily fetch()} call, then aborting the signal will abort the fetch and cause the {\ttfamily fetch()} promise to reject with the reason provided.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18000}{}\doxysubsubsection{\texorpdfstring{Setting {\ttfamily context}}{Setting {\ttfamily context}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18000}
...
{\bfseries{1}}\+: Ie, they\textquotesingle{}re not the "{}same Promise"{}, but they resolve at the same time, because they\textquotesingle{}re both waiting on the same underlying fetch\+Method response.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18002}{}\doxysubsection{\texorpdfstring{{\ttfamily peek(key, \{ allow\+Stale \} = \{\}) =\texorpdfstring{$>$}{>} value}}{{\ttfamily peek(key, \{ allow\+Stale \} = \{\}) =\texorpdfstring{$>$}{>} value}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18002}
Like {\ttfamily get()} but doesn\textquotesingle{}t update recency or delete stale items.

Returns {\ttfamily undefined} if the item is stale, unless {\ttfamily allow\+Stale} is set either on the cache or in the options object.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18003}{}\doxysubsection{\texorpdfstring{{\ttfamily has(key, \{ update\+Age\+On\+Has, status \} = \{\}) =\texorpdfstring{$>$}{>} Boolean}}{{\ttfamily has(key, \{ update\+Age\+On\+Has, status \} = \{\}) =\texorpdfstring{$>$}{>} Boolean}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18003}
...
For the usage of the {\ttfamily status} option, see {\bfseries{Status Tracking}} below.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18004}{}\doxysubsection{\texorpdfstring{{\ttfamily delete(key)}}{{\ttfamily delete(key)}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18004}
Deletes a key out of the cache.

Returns {\ttfamily true} if the key was deleted, {\ttfamily false} otherwise.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18005}{}\doxysubsection{\texorpdfstring{{\ttfamily clear()}}{{\ttfamily clear()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18005}
Clear the cache entirely, throwing away all values.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18006}{}\doxysubsection{\texorpdfstring{{\ttfamily keys()}}{{\ttfamily keys()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18006}
Return a generator yielding the keys in the cache, in order from most recently used to least recently used.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18007}{}\doxysubsection{\texorpdfstring{{\ttfamily rkeys()}}{{\ttfamily rkeys()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18007}
Return a generator yielding the keys in the cache, in order from least recently used to most recently used.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18008}{}\doxysubsection{\texorpdfstring{{\ttfamily values()}}{{\ttfamily values()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18008}
Return a generator yielding the values in the cache, in order from most recently used to least recently used.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18009}{}\doxysubsection{\texorpdfstring{{\ttfamily rvalues()}}{{\ttfamily rvalues()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18009}
Return a generator yielding the values in the cache, in order from least recently used to most recently used.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18010}{}\doxysubsection{\texorpdfstring{{\ttfamily entries()}}{{\ttfamily entries()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18010}
Return a generator yielding {\ttfamily \mbox{[}key, value\mbox{]}} pairs, in order from most recently used to least recently used.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18011}{}\doxysubsection{\texorpdfstring{{\ttfamily rentries()}}{{\ttfamily rentries()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18011}
Return a generator yielding {\ttfamily \mbox{[}key, value\mbox{]}} pairs, in order from least recently used to most recently used.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18012}{}\doxysubsection{\texorpdfstring{{\ttfamily find(fn, \mbox{[}get\+Options\mbox{]})}}{{\ttfamily find(fn, \mbox{[}get\+Options\mbox{]})}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18012}
...
The optional {\ttfamily get\+Options} are applied to the resulting {\ttfamily get()} of the item found.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18013}{}\doxysubsection{\texorpdfstring{{\ttfamily dump()}}{{\ttfamily dump()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18013}
...
Note\+: this returns an actual array, not a generator, so it can be more easily passed around.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18014}{}\doxysubsection{\texorpdfstring{{\ttfamily load(entries)}}{{\ttfamily load(entries)}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18014}
...
The {\ttfamily start} fields are assumed to be calculated relative to a portable {\ttfamily Date.\+now()} timestamp, even if {\ttfamily performance.\+now()} is available.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18015}{}\doxysubsection{\texorpdfstring{{\ttfamily purge\+Stale()}}{{\ttfamily purge\+Stale()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18015}
Delete any stale entries. Returns {\ttfamily true} if anything was removed, {\ttfamily false} otherwise.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18016}{}\doxysubsection{\texorpdfstring{{\ttfamily get\+Remaining\+TTL(key)}}{{\ttfamily get\+Remaining\+TTL(key)}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18016}
Return the number of ms left in the item\textquotesingle{}s TTL. If item is not in cache, returns {\ttfamily 0}. Returns {\ttfamily Infinity} if item is in cache without a defined TTL.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18017}{}\doxysubsection{\texorpdfstring{{\ttfamily for\+Each(fn, \mbox{[}thisp\mbox{]})}}{{\ttfamily for\+Each(fn, \mbox{[}thisp\mbox{]})}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18017}
...
If {\ttfamily thisp} is provided, function will be called in the {\ttfamily this}-\/context of the provided object.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18018}{}\doxysubsection{\texorpdfstring{{\ttfamily rfor\+Each(fn, \mbox{[}thisp\mbox{]})}}{{\ttfamily rfor\+Each(fn, \mbox{[}thisp\mbox{]})}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18018}
Same as {\ttfamily cache.\+for\+Each(fn, thisp)}, but in order from least recently used to most recently used.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18019}{}\doxysubsection{\texorpdfstring{{\ttfamily pop()}}{{\ttfamily pop()}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18019}
Evict the least recently used item, returning its value.

Returns {\ttfamily undefined} if cache is empty.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18020}{}\doxysection{\texorpdfstring{Status Tracking}{Status Tracking}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18020}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18021}{}\doxysection{\texorpdfstring{Storage Bounds Safety}{Storage Bounds Safety}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18021}
...
If that isn\textquotesingle{}t to your liking, check out \href{http://npm.im/@isaacs/ttlcache}{\texttt{ @isaacs/ttlcache}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18022}{}\doxysection{\texorpdfstring{Storing Undefined Values}{Storing Undefined Values}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18022}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18023}{}\doxysection{\texorpdfstring{Performance}{Performance}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18023}
...
\end{DoxyEnumerate}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18024}{}\doxysection{\texorpdfstring{Breaking Changes in Version 7}{Breaking Changes in Version 7}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18024}
...
If you were relying on the internals of LRUCache in version 6 or before, it probably will not work in version 7 and above.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18025}{}\doxysection{\texorpdfstring{Breaking Changes in Version 8}{Breaking Changes in Version 8}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18025}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18026}{}\doxysection{\texorpdfstring{Changes in Version 9}{Changes in Version 9}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2path-scurry_2node__modules_2lru-cache_2_r_e_a_d_m_e_autotoc_md18026}
