\chapter{proxy-\/addr}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e}\index{proxy-\/addr@{proxy-\/addr}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19948}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19948}%
...
Determine address of proxied request\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19949}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19949}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19950}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19950}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ proxyaddr\ =\ require('proxy-\/addr')}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19951}{}\doxysubsection{\texorpdfstring{proxyaddr(req, trust)}{proxyaddr(req, trust)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19951}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19953}{}\doxysubsection{\texorpdfstring{proxyaddr.\+compile(val)}{proxyaddr.\+compile(val)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19953}
...
This function is meant to be optimized for use against every request. It is recommend to compile a trust function up-\/front for the trusted configuration and pass that to {\ttfamily proxyaddr(req, trust)} for each request.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19954}{}\doxysection{\texorpdfstring{Testing}{Testing}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19954}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19955}{}\doxysection{\texorpdfstring{Benchmarks}{Benchmarks}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19955}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ run-\/script\ bench}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19956}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2_r_e_a_d_m_e_autotoc_md19956}
