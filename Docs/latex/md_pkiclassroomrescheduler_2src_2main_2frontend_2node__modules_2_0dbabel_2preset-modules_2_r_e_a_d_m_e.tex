...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e}\index{$<$tt$>$\textbackslash{}"@babel/preset-\/modules$<$/tt$>$@{$<$tt$>$\textbackslash{}"@babel/preset-\/modules$<$/tt$>$}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e_autotoc_md645}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e_autotoc_md645}%
 \begin{quote}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e_autotoc_md646}{}\doxysubsection{\texorpdfstring{Features Supported}{Features Supported}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e_autotoc_md646}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e_autotoc_md647}{}\doxysubsection{\texorpdfstring{Installation \& Usage}{Installation \& Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e_autotoc_md647}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e_autotoc_md648}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e_autotoc_md648}
...
The {\ttfamily loose} setting turns off a rarely-\/needed function name workaround for older versions of Edge. If you\textquotesingle{}re not relying on {\ttfamily Function.\+prototype.\+name}, it\textquotesingle{}s worth enabling loose mode.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e_autotoc_md649}{}\doxysubsection{\texorpdfstring{How does it work?}{How does it work?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e_autotoc_md649}
...
\`{}\`{}\`{}js \end{quote}
\texorpdfstring{$>$}{>}const foo = function foo(\+\_\+ref, b) \{ \begin{quote}
 let \{ a = 1 \} = \+\_\+ref;
...
return \mbox{[}a, b, args\mbox{]}; \end{quote}
\texorpdfstring{$>$}{>}\}; \texorpdfstring{$>$}{>}\`{}\`{}\`{}\`{}

The result is improved bundle size and performance, while supporting the same browsers.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e_autotoc_md650}{}\doxysubsection{\texorpdfstring{Important\+: Minification}{Important\+: Minification}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dbabel_2preset-modules_2_r_e_a_d_m_e_autotoc_md650}
