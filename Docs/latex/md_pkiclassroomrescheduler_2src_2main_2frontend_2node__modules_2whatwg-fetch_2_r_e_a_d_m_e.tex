...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e}\index{window.fetch polyfill@{window.fetch polyfill}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26879}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26879}%
 \href{https://securityscorecards.dev/viewer/?uri=github.com/JakeChampion/fetch}{\texttt{ }}

The {\ttfamily fetch()} function is a Promise-\/based mechanism for programmatically making web requests in the browser. This project is a polyfill that implements a subset of the standard \href{https://fetch.spec.whatwg.org}{\texttt{ Fetch specification}}, enough to make {\ttfamily fetch} a viable replacement for most uses of XMLHttp\+Request in traditional web applications.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26880}{}\doxysection{\texorpdfstring{Table of Contents}{Table of Contents}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26880}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26881}{}\doxysection{\texorpdfstring{Read this first}{Read this first}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26881}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26882}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26882}
...
You will also need a Promise polyfill for \href{https://caniuse.com/promises}{\texttt{ older browsers}}. We recommend \href{https://github.com/taylorhakes/promise-polyfill}{\texttt{ taylorhakes/promise-\/polyfill}} for its small size and Promises/\+A+ compatibility.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26883}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26883}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26884}{}\doxysubsection{\texorpdfstring{Importing}{Importing}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26884}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26885}{}\doxysubsection{\texorpdfstring{HTML}{HTML}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26885}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26886}{}\doxysubsection{\texorpdfstring{JSON}{JSON}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26886}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26887}{}\doxysubsection{\texorpdfstring{Response metadata}{Response metadata}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26887}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26888}{}\doxysubsection{\texorpdfstring{Post form}{Post form}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26888}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26889}{}\doxysubsection{\texorpdfstring{Post JSON}{Post JSON}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26889}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26890}{}\doxysubsection{\texorpdfstring{File upload}{File upload}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26890}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26891}{}\doxysubsection{\texorpdfstring{Caveats}{Caveats}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26891}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26892}{}\doxysubsubsection{\texorpdfstring{Handling HTTP error statuses}{Handling HTTP error statuses}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26892}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26893}{}\doxysubsubsection{\texorpdfstring{Sending cookies}{Sending cookies}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26893}
...
Note\+: due to \href{https://github.com/github/fetch/pull/56\#issuecomment-68835992}{\texttt{ limitations of XMLHttp\+Request}}, using `credentials\+: \textquotesingle{}omit'\`{} is not respected for same domains in browsers where this polyfill is active. Cookies will always be sent to same domains in older browsers.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26894}{}\doxysubsubsection{\texorpdfstring{Receiving cookies}{Receiving cookies}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26894}
As with XMLHttp\+Request, the {\ttfamily Set-\/\+Cookie} response header returned from the server is a \href{https://developer.mozilla.org/en-US/docs/Glossary/Forbidden_header_name}{\texttt{ forbidden header name}} and therefore can\textquotesingle{}t be programmatically read with {\ttfamily response.\+headers.\+get()}. Instead, it\textquotesingle{}s the browser\textquotesingle{}s responsibility to handle new cookies being set (if applicable to the current URL). Unless they are HTTP-\/only, new cookies will be available through {\ttfamily document.\+cookie}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26895}{}\doxysubsubsection{\texorpdfstring{Redirect modes}{Redirect modes}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26895}
...
Due to limitations of XMLHttp\+Request, only the "{}follow"{} mode is available in browsers where this polyfill is active.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26896}{}\doxysubsubsection{\texorpdfstring{Obtaining the Response URL}{Obtaining the Response URL}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26896}
...
This server workaround is necessary if you need reliable {\ttfamily response.\+url} in Firefox \texorpdfstring{$<$}{<} 32, Chrome \texorpdfstring{$<$}{<} 37, Safari, or IE.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26897}{}\doxysubsubsection{\texorpdfstring{Aborting requests}{Aborting requests}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26897}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26898}{}\doxysection{\texorpdfstring{Browser Support}{Browser Support}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-fetch_2_r_e_a_d_m_e_autotoc_md26898}
