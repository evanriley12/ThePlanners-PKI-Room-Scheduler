\chapter{websocket-\/extensions \texorpdfstring{$<$}{<}a href="{}http\+://travis-\/ci.\+org/faye/websocket-\/extensions-\/node"{} \texorpdfstring{$>$}{>}\texorpdfstring{$<$}{<}img src="{}https\+://secure.\+travis-\/ci.\+org/faye/websocket-\/extensions-\/node.\+svg"{} alt="{}\+Build status"{}/\texorpdfstring{$>$}{>}\texorpdfstring{$<$}{<}/a\texorpdfstring{$>$}{>}}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e}\index{websocket-\/extensions $<$a href="{}http://travis-\/ci.org/faye/websocket-\/extensions-\/node"{} $>$$<$img src="{}https://secure.travis-\/ci.org/faye/websocket-\/extensions-\/node.svg"{} alt="{}Build status"{}/$>$$<$/a$>$@{websocket-\/extensions $<$a href=""http://travis-\/ci.org/faye/websocket-\/extensions-\/node"" $>$$<$img src=""https://secure.travis-\/ci.org/faye/websocket-\/extensions-\/node.svg"" alt=""Build status""/$>$$<$/a$>$}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26859}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26859}%
...
{\ttfamily websocket-\/extensions} provides a container for registering extension plugins, and provides all the functions required to negotiate which extensions to use during a session via the {\ttfamily Sec-\/\+Web\+Socket-\/\+Extensions} header. By implementing the APIs defined in this document, an extension may be used by any Web\+Socket library based on this framework.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26860}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26860}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ websocket-\/extensions}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26861}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26861}
...
The library is designed with the aim that any protocol implementation and any extension can be used together, so long as they support the same abstract representation of frames and messages.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26862}{}\doxysubsection{\texorpdfstring{Data types}{Data types}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26862}
The APIs provided by the framework rely on two data types; extensions will expect to be given data and to be able to return data in these formats\+:\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26863}{}\doxysubsubsection{\texorpdfstring{{\itshape Frame}}{{\itshape Frame}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26863}
...
\end{longtabu}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26864}{}\doxysubsubsection{\texorpdfstring{{\itshape Message}}{{\itshape Message}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26864}
...
\end{longtabu}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26865}{}\doxysubsection{\texorpdfstring{For driver authors}{For driver authors}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26865}
...
In the following examples, {\ttfamily exts} refers to this {\ttfamily Extensions} instance.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26866}{}\doxysubsubsection{\texorpdfstring{Client sessions}{Client sessions}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26866}
...
If the server has sent any extension responses that the client does not recognize, or are in conflict with one another for use of RSV bits, or that use invalid parameters for the named extensions, then {\ttfamily exts.\+activate()} will {\ttfamily throw}. In this event, the client driver should fail the connection with closing code {\ttfamily 1010}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26867}{}\doxysubsubsection{\texorpdfstring{Server sessions}{Server sessions}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26867}
...
Calling {\ttfamily exts.\+generate\+Response(header)} activates those extensions the client has asked to use, if they are registered, asks each extension for a set of response parameters, and returns a string containing the response parameters for all accepted extensions.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26868}{}\doxysubsubsection{\texorpdfstring{In both directions}{In both directions}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26868}
...
The callback is invoked when all extensions have finished processing any messages in the pipeline and it\textquotesingle{}s safe to close the socket.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26869}{}\doxysubsection{\texorpdfstring{For extension authors}{For extension authors}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26869}
...
The extension must decide which set of parameters it wants to accept, if any, and return a {\itshape Server\+Session} if it wants to accept the parameters and {\ttfamily null} otherwise.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26870}{}\doxysubsubsection{\texorpdfstring{{\itshape Client\+Session}}{{\itshape Client\+Session}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26870}
...
This returns the set of parameters the server session wants to send in its {\ttfamily Sec-\/\+Web\+Socket-\/\+Extensions} response header. Only one set of parameters is returned to the client per extension. Server sessions that would confict on their use of RSV bits are not activated.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26872}{}\doxysubsubsection{\texorpdfstring{{\itshape Session}}{{\itshape Session}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26872}
...
The framework will call this method when the Web\+Socket session ends, allowing the session to release any resources it\textquotesingle{}s using.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26873}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2_r_e_a_d_m_e_autotoc_md26873}
