\chapter{BFJ}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e}\index{BFJ@{BFJ}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6037}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6037}%
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6038}{}\doxysection{\texorpdfstring{Why would I want those?}{Why would I want those?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6038}
If you need to parse huge JSON strings or stringify huge Java\+Script data sets, it monopolises the event loop and can lead to out-\/of-\/memory exceptions. BFJ implements asynchronous functions and uses pre-\/allocated fixed-\/length arrays to try and alleviate those issues.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6039}{}\doxysection{\texorpdfstring{Is it fast?}{Is it fast?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6039}
No.
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6041}{}\doxysection{\texorpdfstring{How do I install it?}{How do I install it?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6041}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6042}{}\doxysection{\texorpdfstring{How do I read a JSON file?}{How do I read a JSON file?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6042}
...
If there are no syntax errors, the returned promise is resolved with the parsed data. If syntax errors occur, the promise is rejected with the first error.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6043}{}\doxysection{\texorpdfstring{How do I parse a stream of JSON?}{How do I parse a stream of JSON?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6043}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6044}{}\doxysection{\texorpdfstring{How do I selectively parse individual items from a JSON stream?}{How do I selectively parse individual items from a JSON stream?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6044}
...
If there are any syntax errors in the JSON, a {\ttfamily data\+Error} event will be emitted. If any other errors occur, an {\ttfamily error} event will be emitted.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6045}{}\doxysection{\texorpdfstring{How do I write a JSON file?}{How do I write a JSON file?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6045}
...
It takes three arguments; the path to the JSON file, the data structure to serialise and an options object.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6046}{}\doxysection{\texorpdfstring{How do I create a stream of JSON?}{How do I create a stream of JSON?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6046}
...
If there a circular reference is encountered in the data and {\ttfamily options.\+circular} is not set to `\textquotesingle{}ignore'{\ttfamily , a}data\+Error{\ttfamily event will be emitted. If any other errors occur, an}error\`{} event will be emitted.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6047}{}\doxysection{\texorpdfstring{How do I create a JSON string?}{How do I create a JSON string?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6047}
...
It takes two arguments; the data structure to serialise and an options object.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6048}{}\doxysection{\texorpdfstring{What other methods are there?}{What other methods are there?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6048}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6049}{}\doxysubsection{\texorpdfstring{bfj.\+walk (stream, options)}{bfj.\+walk (stream, options)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6049}
...
If you are using {\ttfamily bfj.\+walk} to sequentially parse items in an array, you might also be interested in the \href{https://github.com/hash-bang/bfj-collections}{\texttt{ bfj-\/collections}} module.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6050}{}\doxysubsection{\texorpdfstring{bfj.\+eventify (data, options)}{bfj.\+eventify (data, options)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6050}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6051}{}\doxysection{\texorpdfstring{What options can I specify?}{What options can I specify?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6051}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6052}{}\doxysubsection{\texorpdfstring{Options for parsing functions}{Options for parsing functions}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6052}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6053}{}\doxysubsection{\texorpdfstring{Options for serialisation functions}{Options for serialisation functions}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6053}
...
\item {\ttfamily options.\+Promise}\+: Promise constructor that will be used for promises returned by all methods. If you set this option, please be aware that some promise implementations (including native promises) may cause your process to die with out-\/of-\/memory exceptions. Defaults to \href{http://bluebirdjs.com/docs/api-reference.html}{\texttt{ bluebird\textquotesingle{}s implementation}}, which does not have that problem.
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6054}{}\doxysection{\texorpdfstring{Is it possible to pause parsing or serialisation from calling code?}{Is it possible to pause parsing or serialisation from calling code?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6054}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6055}{}\doxysection{\texorpdfstring{Can it handle \href{http://ndjson.org/}{\texttt{ newline-\/delimited JSON (NDJSON)}}?}{Can it handle \href{http://ndjson.org/}{\texttt{ newline-\/delimited JSON (NDJSON)}}?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6055}
...
{\ttfamily bfj.\+unpipe} and {\ttfamily bfj.\+read} will not parse NDJSON.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6056}{}\doxysection{\texorpdfstring{Why does it default to bluebird promises?}{Why does it default to bluebird promises?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6056}
Until version {\ttfamily 4.\+2.\+4}, native promises were used. But they were found to cause out-\/of-\/memory errors when serialising large amounts of data to JSON, due to \href{https://alexn.org/blog/2017/10/11/javascript-promise-leaks-memory.html}{\texttt{ well-\/documented problems with the native promise implementation}}. So in version {\ttfamily 5.\+0.\+0}, bluebird promises were used instead. In version {\ttfamily 5.\+1.\+0}, an option was added that enables callers to specify the promise constructor to use. Use it at your own risk.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6057}{}\doxysection{\texorpdfstring{Can I specify a different promise implementation?}{Can I specify a different promise implementation?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6057}
Yes. Just pass the {\ttfamily Promise} option to any method. If you get out-\/of-\/memory errors when using that option, consider changing your promise implementation.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6058}{}\doxysection{\texorpdfstring{Is there a change log?}{Is there a change log?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6058}
\doxysectlink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_h_i_s_t_o_r_y}{Yes}{0}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6059}{}\doxysection{\texorpdfstring{How do I set up the dev environment?}{How do I set up the dev environment?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6059}
...
You can run the tests with the command {\ttfamily npm test}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6060}{}\doxysection{\texorpdfstring{What versions of Node.\+js does it support?}{What versions of Node.\+js does it support?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6060}
...
Until \href{HISTORY.md\#212}{\texttt{ version {\ttfamily 2.\+1.\+2}}}, only Node.\+js versions 4 or greater were supported.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6061}{}\doxysection{\texorpdfstring{What license is it released under?}{What license is it released under?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2bfj_2_r_e_a_d_m_e_autotoc_md6061}
