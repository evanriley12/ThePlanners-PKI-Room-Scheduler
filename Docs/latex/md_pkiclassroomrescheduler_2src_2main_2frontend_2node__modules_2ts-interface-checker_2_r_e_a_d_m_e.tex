\chapter{ts-\/interface-\/checker}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e}\index{ts-\/interface-\/checker@{ts-\/interface-\/checker}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25647}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25647}%
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25649}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25649}
...
Note that {\ttfamily ts-\/interface-\/builder} is only needed for the build-\/time step, and {\ttfamily ts-\/interface-\/checker} is needed at runtime. That\textquotesingle{}s why the recommendation is to npm-\/install the former using {\ttfamily -\/-\/save-\/dev} flag and the latter using {\ttfamily -\/-\/save}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25650}{}\doxysection{\texorpdfstring{Checking method calls}{Checking method calls}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25650}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25651}{}\doxysection{\texorpdfstring{Type suites}{Type suites}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25651}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25652}{}\doxysection{\texorpdfstring{Strict checking}{Strict checking}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25652}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25653}{}\doxysection{\texorpdfstring{Type guards}{Type guards}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25653}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25654}{}\doxysection{\texorpdfstring{Type assertions}{Type assertions}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2ts-interface-checker_2_r_e_a_d_m_e_autotoc_md25654}
