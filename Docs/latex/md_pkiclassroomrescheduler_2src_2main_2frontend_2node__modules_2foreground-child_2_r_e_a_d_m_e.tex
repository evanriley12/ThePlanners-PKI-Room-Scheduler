\chapter{foreground-\/child}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2_r_e_a_d_m_e}\index{foreground-\/child@{foreground-\/child}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2_r_e_a_d_m_e_autotoc_md12614}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2_r_e_a_d_m_e_autotoc_md12614}%
 Run a child as if it\textquotesingle{}s the foreground process. Give it stdio. Exit when it exits.

Mostly this module is here to support some use cases around wrapping child processes for test coverage and such. But it\textquotesingle{}s also generally useful any time you want one program to execute another as if it\textquotesingle{}s the "{}main"{} process, for example, if a program takes a {\ttfamily -\/-\/cmd} argument to execute in some way.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2_r_e_a_d_m_e_autotoc_md12615}{}\doxysection{\texorpdfstring{USAGE}{USAGE}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2_r_e_a_d_m_e_autotoc_md12615}
...
If the callback returns a string value, then that will be used as the signal to exit the parent process. If it returns a number, then that number will be used as the parent exit status code. If it returns boolean {\ttfamily false}, then the parent process will not be terminated. If it returns {\ttfamily undefined}, then it will exit with the same signal/code as the child process.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2_r_e_a_d_m_e_autotoc_md12616}{}\doxysection{\texorpdfstring{Caveats}{Caveats}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2foreground-child_2_r_e_a_d_m_e_autotoc_md12616}
