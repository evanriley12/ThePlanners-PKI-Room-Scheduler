\chapter{README}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e}\index{README@{README}}
...
Read \href{https://github.com/tvcutsem/harmony-reflect/wiki}{\texttt{ Why should I use this library?}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13428}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13428}
...
\end{DoxyVerb}
 See below for a list of spec incompatibilities and other gotcha\textquotesingle{}s.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13429}{}\doxysection{\texorpdfstring{API Docs}{API Docs}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13429}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13430}{}\doxysection{\texorpdfstring{Compatibility}{Compatibility}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13430}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13431}{}\doxysection{\texorpdfstring{Dependencies}{Dependencies}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13431}
...
Reflect
\end{DoxyVerb}
 \+:warning\+: In node.\+js, when you `require(\textquotesingle{}harmony-\/reflect'){\ttfamily , only the current module\textquotesingle{}s globals are patched. If you pass an emulated direct proxy to an external module, and that module uses the unpatched globals, the module may not interact with the proxy according to the latest ES6 Proxy API, instead falling back on the old pre-\/\+ES6 Proxy API. This can cause bugs, e.\+g. the built-\/in}Array.\+is\+Array{\ttfamily will return}false{\ttfamily when passed a proxy-\/for-\/array, while the patched}Array.\+is\+Array\`{} will return true. I know of no good fix to reliably patch the globals for all node modules. If you do, let me know.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13432}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13432}
...
For more examples of proxies, and a good overview of their design rationale, I recommend reading \href{http://www.2ality.com/2014/12/es6-proxies.html}{\texttt{ Axel Rauschmayer\textquotesingle{}s blog post on proxies}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13433}{}\doxysection{\texorpdfstring{Proxy Handler API}{Proxy Handler API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13433}
The sister project \href{https://github.com/tvcutsem/proxy-handlers}{\texttt{ proxy-\/handlers}} defines a number of predefined Proxy handlers as "{}abstract classes"{} that your code can "{}subclass"{} The goal is to minimize the number of traps that your proxy handlers must implement.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13434}{}\doxysection{\texorpdfstring{Spec Incompatibilities and other gotcha\textquotesingle{}s}{Spec Incompatibilities and other gotcha\textquotesingle{}s}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2harmony-reflect_2_r_e_a_d_m_e_autotoc_md13434}
