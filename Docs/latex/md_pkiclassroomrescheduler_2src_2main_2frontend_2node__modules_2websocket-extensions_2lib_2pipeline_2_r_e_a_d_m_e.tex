...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e}\index{Extension pipelining@{Extension pipelining}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26850}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26850}%
...
Asynchronous processing of messages poses a number of problems that this pipeline construction is intended to solve.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26851}{}\doxysection{\texorpdfstring{Overview}{Overview}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26851}
...
Essentially, we must defer closing the sessions and sending a closing frame until after all prior messages have exited the pipeline.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26852}{}\doxysection{\texorpdfstring{Design goals}{Design goals}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26852}
...
So, input should be handed off to sessions as soon as possible, and all we need is a mechanism to reorder the output so that message order is preserved for the next session in line.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26853}{}\doxysection{\texorpdfstring{Solution}{Solution}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26853}
...
A driver using this framework holds an instance of the {\ttfamily Extensions} class, which it uses to register extension plugins, negotiate headers and transform messages. The {\ttfamily Extensions} instance itself holds a {\ttfamily Pipeline}, which contains an array of {\ttfamily Cell} objects, each of which wraps one of the sessions.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26854}{}\doxysubsection{\texorpdfstring{Message processing}{Message processing}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26854}
...
This satisfies the message transformation requirements\+: the {\ttfamily Pipeline} simply loops over the cells in the appropriate direction to transform each message. Because each {\ttfamily Cell} will preserve message order, we can pass a message to the next {\ttfamily Cell} in line as soon as the current {\ttfamily Cell} returns it. This gives each {\ttfamily Cell} all the messages in order while maximising throughput.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26855}{}\doxysubsection{\texorpdfstring{Session closing}{Session closing}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26855}
...
Some unnecessary work may happen, for example any messages already in the pipeline following {\itshape m2} will be processed by {\ttfamily A}, since it\textquotesingle{}s upstream of the error. Those messages will be dropped by {\ttfamily B}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26857}{}\doxysection{\texorpdfstring{Alternative ideas}{Alternative ideas}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26857}
I am considering implementing {\ttfamily Functor} as an object-\/mode transform stream rather than what is essentially an async function. Being object-\/mode, a stream would preserve message boundaries and would also possibly help address back-\/pressure. I\textquotesingle{}m not sure whether this would require external API changes so that such streams could be connected to the downstream driver\textquotesingle{}s streams.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26858}{}\doxysection{\texorpdfstring{Acknowledgements}{Acknowledgements}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2websocket-extensions_2lib_2pipeline_2_r_e_a_d_m_e_autotoc_md26858}
