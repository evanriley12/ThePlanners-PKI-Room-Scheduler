...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e}\index{file-\/entry-\/cache@{file-\/entry-\/cache}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12118}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12118}%
\begin{quote}
...
\href{https://npmjs.org/package/file-entry-cache}{\texttt{ }} \href{https://travis-ci.org/royriojas/file-entry-cache}{\texttt{ }}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12119}{}\doxysection{\texorpdfstring{install}{install}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12119}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ i\ -\/-\/save\ file-\/entry-\/cache}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12120}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12120}
The module exposes two functions {\ttfamily create} and {\ttfamily create\+From\+File}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12121}{}\doxysection{\texorpdfstring{{\ttfamily create(cache\+Name, \mbox{[}directory, use\+Check\+Sum\mbox{]})}}{{\ttfamily create(cache\+Name, \mbox{[}directory, use\+Check\+Sum\mbox{]})}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12121}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12122}{}\doxysection{\texorpdfstring{{\ttfamily create\+From\+File(path\+To\+Cache, \mbox{[}use\+Check\+Sum\mbox{]})}}{{\ttfamily create\+From\+File(path\+To\+Cache, \mbox{[}use\+Check\+Sum\mbox{]})}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12122}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12123}{}\doxysection{\texorpdfstring{Motivation for this module}{Motivation for this module}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12123}
...
In the worst case scenario all the files will be processed. In the best case scenario only a few of them will be processed.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12124}{}\doxysection{\texorpdfstring{Important notes}{Important notes}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12124}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12125}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2file-entry-cache_2_r_e_a_d_m_e_autotoc_md12125}
MIT 