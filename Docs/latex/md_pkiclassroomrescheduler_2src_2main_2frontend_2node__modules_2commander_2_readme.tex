...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme}\index{Commander.js@{Commander.js}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7350}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7350}%
...
The complete solution for \href{http://nodejs.org}{\texttt{ node.\+js}} command-\/line interfaces, inspired by Ruby\textquotesingle{}s \href{https://github.com/commander-rb/commander}{\texttt{ commander}}. ~\newline
 \href{http://tj.github.com/commander.js/}{\texttt{ API documentation}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7351}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7351}
\begin{DoxyVerb}$ npm install commander
\end{DoxyVerb}
 \hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7352}{}\doxysection{\texorpdfstring{Option parsing}{Option parsing}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7352}
...
{\bfseries{NOTE}}\+: If you pass a argument without using brackets the example above will return true and not the value passed in.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7353}{}\doxysection{\texorpdfstring{Version option}{Version option}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7353}
...
The version flags can be named anything, but the long option is required.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7354}{}\doxysection{\texorpdfstring{Command-\/specific options}{Command-\/specific options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7354}
...
A command\textquotesingle{}s options are validated when the command is used. Any unknown options will be reported as an error. However, if an action-\/based command does not define an action, then the options are not validated.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7355}{}\doxysection{\texorpdfstring{Coercion}{Coercion}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7355}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7356}{}\doxysection{\texorpdfstring{Regular Expression}{Regular Expression}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7356}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7357}{}\doxysection{\texorpdfstring{Variadic arguments}{Variadic arguments}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7357}
...
An {\ttfamily Array} is used for the value of a variadic argument. This applies to {\ttfamily program.\+args} as well as the argument passed to your action as demonstrated above.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7358}{}\doxysection{\texorpdfstring{Specify the argument syntax}{Specify the argument syntax}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7358}
...
\end{DoxyCode}
 Angled brackets (e.\+g. {\ttfamily \texorpdfstring{$<$}{<}cmd\texorpdfstring{$>$}{>}}) indicate required input. Square brackets (e.\+g. {\ttfamily \mbox{[}env\mbox{]}}) indicate optional input.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7359}{}\doxysection{\texorpdfstring{Git-\/style sub-\/commands}{Git-\/style sub-\/commands}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7359}
...
If the program is designed to be installed globally, make sure the executables have proper modes, like {\ttfamily 755}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7360}{}\doxysubsection{\texorpdfstring{{\ttfamily -\/-\/harmony}}{{\ttfamily -\/-\/harmony}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7360}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7361}{}\doxysection{\texorpdfstring{Automated --help}{Automated --help}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7361}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7362}{}\doxysection{\texorpdfstring{Custom help}{Custom help}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7362}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7363}{}\doxysection{\texorpdfstring{.output\+Help(cb)}{.output\+Help(cb)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7363}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7364}{}\doxysection{\texorpdfstring{.help(cb)}{.help(cb)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7364}
Output help information and exit immediately. Optional callback cb allows post-\/processing of help text before it is displayed.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7365}{}\doxysection{\texorpdfstring{Custom event listeners}{Custom event listeners}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7365}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7366}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7366}
...
More Demos can be found in the \href{https://github.com/tj/commander.js/tree/master/examples}{\texttt{ examples}} directory.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7367}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2commander_2_readme_autotoc_md7367}
