...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer}\index{Porting to the Buffer.from/Buffer.alloc API@{Porting to the Buffer.from/Buffer.alloc API}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22292}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22292}%
 \label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_overview}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_overview}%
 \hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22293}{}\doxysection{\texorpdfstring{Overview}{Overview}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22293}

\begin{DoxyItemize}
\item \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_variant-1}{Variant 1\+: Drop support for Node.js ≤ 4.4.x and 5.0.0 — 5.9.x.} ({\itshape recommended})
\item \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_variant-2}{Variant 2\+: Use a polyfill}
\item \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_variant-3}{Variant 3\+: manual detection, with safeguards}
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22294}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using grep}{Finding problematic bits of code using grep}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22294}
...
It will find all the potentially unsafe places in your own code (with some considerably unlikely exceptions).\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22295}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using Node.\+js 8}{Finding problematic bits of code using Node.\+js 8}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22295}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22296}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using linters}{Finding problematic bits of code using linters}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22296}
...
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_variant-1}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_variant-1}%
 \hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22297}{}\doxysection{\texorpdfstring{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22297}
...
{\itshape If you currently support those older Node.\+js versions and dropping them would be a semver-\/major change for you, or if you support older branches of your packages, consider using \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_variant-2}{Variant 2} or \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_variant-3}{Variant 3} on older branches, so people using those older branches will also receive the fix. That way, you will eradicate potential issues caused by unguarded Buffer API usage and your users will not observe a runtime deprecation warning when running your code on Node.\+js 10.}

\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_variant-2}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_variant-2}%
 \hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22298}{}\doxysection{\texorpdfstring{Variant 2\+: Use a polyfill}{Variant 2\+: Use a polyfill}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22298}
Utilize \href{https://www.npmjs.com/package/safer-buffer}{\texttt{ safer-\/buffer}} as a polyfill to support older Node.\+js versions.

You would take exacly the same steps as in \doxylink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_variant-1}{Variant 1}, but with a polyfill `const Buffer = require(\textquotesingle{}safer-\/buffer').Buffer{\ttfamily in all files where you use the new}Buffer\`{} api.
...
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_variant-3}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_variant-3}%
 \hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22299}{}\doxysection{\texorpdfstring{Variant 3 — manual detection, with safeguards}{Variant 3 — manual detection, with safeguards}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22299}
This is useful if you create Buffer instances in only a few places (e.\+g. one), or you have your own wrapper around them.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22300}{}\doxysubsection{\texorpdfstring{Buffer(0)}{Buffer(0)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22300}
This special case for creating empty buffers can be safely replaced with {\ttfamily Buffer.\+concat(\mbox{[}$\,$\mbox{]})}, which returns the same result all the way down to Node.\+js 0.\+8.\+x.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22301}{}\doxysubsection{\texorpdfstring{Buffer(not\+Number)}{Buffer(not\+Number)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22301}
Before\+:
...
Also note that using Type\+Script does not fix this problem for you — when libs written in {\ttfamily Type\+Script} are used from JS, or when user input ends up there — it behaves exactly as pure JS, as all type checks are translation-\/time only and are not present in the actual JS code which TS compiles to.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22302}{}\doxysubsection{\texorpdfstring{Buffer(number)}{Buffer(number)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22302}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22303}{}\doxysection{\texorpdfstring{Regarding Buffer.\+alloc\+Unsafe}{Regarding Buffer.\+alloc\+Unsafe}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22303}
...
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_faq}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_faq}%
 \hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22304}{}\doxysection{\texorpdfstring{FAQ}{FAQ}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22304}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_design-flaws}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_design-flaws}%
 \hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22305}{}\doxysubsection{\texorpdfstring{What is wrong with the {\ttfamily Buffer} constructor?}{What is wrong with the {\ttfamily Buffer} constructor?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22305}
...
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_ecosystem-usage}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_ecosystem-usage}%
 \hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22306}{}\doxysubsection{\texorpdfstring{The {\ttfamily Buffer()} constructor has been deprecated for a while. Is this really an issue?}{The {\ttfamily Buffer()} constructor has been deprecated for a while. Is this really an issue?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md22306}
