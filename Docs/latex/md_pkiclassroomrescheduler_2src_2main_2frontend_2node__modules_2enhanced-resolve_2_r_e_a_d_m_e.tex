...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e}\index{enhanced-\/resolve@{enhanced-\/resolve}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8946}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8946}%
...
Offers an async require.\+resolve function. It\textquotesingle{}s highly configurable.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8947}{}\doxysection{\texorpdfstring{Features}{Features}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8947}

\begin{DoxyItemize}
\item plugin system
\item provide a custom filesystem
\item sync and async node.\+js filesystems included
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8948}{}\doxysection{\texorpdfstring{Getting Started}{Getting Started}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8948}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8949}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8949}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8950}{}\doxysubsection{\texorpdfstring{Resolve}{Resolve}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8950}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8951}{}\doxysubsection{\texorpdfstring{Creating a Resolver}{Creating a Resolver}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8951}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8952}{}\doxysubsubsection{\texorpdfstring{Resolver Options}{Resolver Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8952}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8953}{}\doxysection{\texorpdfstring{Plugins}{Plugins}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8953}
...
A plugin should be a {\ttfamily class} (or its ES5 equivalent) with an {\ttfamily apply} method. The {\ttfamily apply} method will receive a {\ttfamily resolver} instance, that can be used to hook in to the event system.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8954}{}\doxysubsection{\texorpdfstring{Plugin Boilerplate}{Plugin Boilerplate}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8954}
...
Plugins are executed in a pipeline, and register which event they should be executed before/after. In the example above, {\ttfamily source} is the name of the event that starts the pipeline, and {\ttfamily target} is what event this plugin should fire, which is what continues the execution of the pipeline. For an example of how these different plugin events create a chain, see {\ttfamily lib/\+Resolver\+Factory.\+js}, in the {\ttfamily //// pipeline ////} section.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8955}{}\doxysection{\texorpdfstring{Escaping}{Escaping}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8955}
It\textquotesingle{}s allowed to escape {\ttfamily \#} as {\ttfamily \textbackslash{}0\#} to avoid parsing it as fragment.

enhanced-\/resolve will try to resolve requests containing {\ttfamily \#} as path and as fragment, so it will automatically figure out if {\ttfamily ./some\#thing} means {\ttfamily .../some.js\#thing} or {\ttfamily .../some\#thing.\+js}. When a {\ttfamily \#} is resolved as path it will be escaped in the result. Here\+: {\ttfamily .../some\textbackslash{}0\#thing.\+js}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8956}{}\doxysection{\texorpdfstring{Tests}{Tests}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8956}

\begin{DoxyCode}{0}
\DoxyCodeLine{yarn\ test}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8957}{}\doxysection{\texorpdfstring{Passing options from webpack}{Passing options from webpack}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8957}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8958}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md8958}
