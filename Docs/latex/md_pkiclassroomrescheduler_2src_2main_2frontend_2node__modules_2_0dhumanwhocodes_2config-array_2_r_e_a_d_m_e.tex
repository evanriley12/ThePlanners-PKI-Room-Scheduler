...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e}\index{Config Array@{Config Array}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1241}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1241}%
 by \href{https://humanwhocodes.com}{\texttt{ Nicholas C. Zakas}}

If you find this useful, please consider supporting my work with a \href{https://humanwhocodes.com/donate}{\texttt{ donation}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1242}{}\doxysection{\texorpdfstring{Description}{Description}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1242}
A config array is a way of managing configurations that are based on glob pattern matching of filenames. Each config array contains the information needed to determine the correct configuration for any file based on the filename.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1243}{}\doxysection{\texorpdfstring{Background}{Background}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1243}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1245}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1245}
...
This example reads in an object or array from {\ttfamily my.\+config.\+js} and passes it into the {\ttfamily Config\+Array} constructor as the first argument. The second argument is an object specifying the {\ttfamily base\+Path} (the directory in which {\ttfamily my.\+config.\+js} is found) and a {\ttfamily schema} to define the additional properties of a config object beyond {\ttfamily files}, {\ttfamily ignores}, and {\ttfamily name}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1246}{}\doxysubsection{\texorpdfstring{Specifying a Schema}{Specifying a Schema}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1246}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1247}{}\doxysubsection{\texorpdfstring{Config Arrays}{Config Arrays}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1247}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1248}{}\doxysubsection{\texorpdfstring{Config Functions}{Config Functions}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1248}
...
{\bfseries{Note\+:}} Config functions can also be async.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1249}{}\doxysubsection{\texorpdfstring{Normalizing Config Arrays}{Normalizing Config Arrays}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1249}
...
{\bfseries{Important\+:}} Once a {\ttfamily Config\+Array} is normalized, it cannot be changed further. You can, however, create a new {\ttfamily Config\+Array} and pass in the normalized instance to create an unnormalized copy.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1250}{}\doxysubsection{\texorpdfstring{Getting Config for a File}{Getting Config for a File}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1250}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1251}{}\doxysection{\texorpdfstring{Determining Ignored Paths}{Determining Ignored Paths}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1251}
...
{\bfseries{Important\+:}} A pattern such as {\ttfamily foo/\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}} means that {\ttfamily foo} and {\ttfamily foo/} are {\itshape not} ignored whereas {\ttfamily foo/bar} is ignored. If you want to ignore {\ttfamily foo} and all of its subdirectories, use the pattern {\ttfamily foo} or {\ttfamily foo/} in {\ttfamily ignores}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1252}{}\doxysection{\texorpdfstring{Caching Mechanisms}{Caching Mechanisms}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1252}
...
\end{DoxyEnumerate}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1253}{}\doxysection{\texorpdfstring{Acknowledgements}{Acknowledgements}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1253}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1254}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2_0dhumanwhocodes_2config-array_2_r_e_a_d_m_e_autotoc_md1254}
Apache 2.\+0 