\chapter{minipass}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e}\index{minipass@{minipass}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16930}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16930}%
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16931}{}\doxysection{\texorpdfstring{Usage in Type\+Script}{Usage in Type\+Script}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16931}
...
Emitting/handling events that aren\textquotesingle{}t declared in this way is fine, but the arguments will be typed as {\ttfamily unknown}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16932}{}\doxysection{\texorpdfstring{Differences from Node.\+js Streams}{Differences from Node.\+js Streams}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16932}
...
You can avoid most of these differences entirely (for a very small performance penalty) by setting {\ttfamily \{async\+: true\}} in the constructor options.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16933}{}\doxysubsection{\texorpdfstring{Timing}{Timing}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16933}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16934}{}\doxysubsection{\texorpdfstring{Exception\+: Async Opt-\/\+In}{Exception\+: Async Opt-\/\+In}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16934}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16935}{}\doxysubsection{\texorpdfstring{No High/\+Low Water Marks}{No High/\+Low Water Marks}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16935}
...
Since nothing is ever buffered unnecessarily, there is much less copying data, and less bookkeeping about buffer capacity levels.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16936}{}\doxysubsection{\texorpdfstring{Hazards of Buffering (or\+: Why Minipass Is So Fast)}{Hazards of Buffering (or\+: Why Minipass Is So Fast)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16936}
...
As always, the faster implementation is the one that does less stuff and waits less time to do it.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16937}{}\doxysubsection{\texorpdfstring{Immediately emit {\ttfamily end} for empty streams (when not paused)}{Immediately emit {\ttfamily end} for empty streams (when not paused)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16937}
...
However, this is {\itshape usually} not a problem because\+:\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16938}{}\doxysubsection{\texorpdfstring{Emit {\ttfamily end} When Asked}{Emit {\ttfamily end} When Asked}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16938}
...
To prevent calling handlers multiple times who would not expect multiple ends to occur, all listeners are removed from the `\textquotesingle{}end'\`{} event whenever it is emitted.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16939}{}\doxysubsection{\texorpdfstring{Emit {\ttfamily error} When Asked}{Emit {\ttfamily error} When Asked}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16939}
...
This makes it much more difficult to end up trying to interact with a broken stream, if the error handler is added after an error was previously emitted.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16940}{}\doxysubsection{\texorpdfstring{Impact of "{}immediate flow"{} on Tee-\/streams}{Impact of "{}immediate flow"{} on Tee-\/streams}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16940}
...
All of the hazards in this section are avoided by setting {\ttfamily \{ async\+: true \}} in the Minipass constructor, or by setting {\ttfamily stream.\+async = true} afterwards. Note that this does add some overhead, so should only be done in cases where you are willing to lose a bit of performance in order to avoid having to refactor program logic.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16941}{}\doxysection{\texorpdfstring{USAGE}{USAGE}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16941}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16942}{}\doxysubsection{\texorpdfstring{OPTIONS}{OPTIONS}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16942}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16943}{}\doxysubsection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16943}
Implements the user-\/facing portions of Node.\+js\textquotesingle{}s {\ttfamily Readable} and {\ttfamily Writable} streams.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16944}{}\doxysubsection{\texorpdfstring{Methods}{Methods}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16944}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16945}{}\doxysubsection{\texorpdfstring{Properties}{Properties}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16945}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16946}{}\doxysubsection{\texorpdfstring{Events}{Events}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16946}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16947}{}\doxysubsection{\texorpdfstring{Static Methods}{Static Methods}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16947}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16948}{}\doxysection{\texorpdfstring{EXAMPLES}{EXAMPLES}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16948}
Here are some examples of things you can do with Minipass streams.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16949}{}\doxysubsection{\texorpdfstring{simple "{}are you done yet"{} promise}{simple "{}are you done yet"{} promise}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16949}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16950}{}\doxysubsection{\texorpdfstring{collecting}{collecting}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16950}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16951}{}\doxysubsection{\texorpdfstring{collecting into a single blob}{collecting into a single blob}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16951}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16952}{}\doxysubsection{\texorpdfstring{iteration}{iteration}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16952}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16953}{}\doxysubsection{\texorpdfstring{subclass that {\ttfamily console.\+log()}s everything written into it}{subclass that {\ttfamily console.\+log()}s everything written into it}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16953}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16954}{}\doxysubsection{\texorpdfstring{same thing, but using an inline anonymous class}{same thing, but using an inline anonymous class}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16954}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16955}{}\doxysubsection{\texorpdfstring{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16955}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16956}{}\doxysubsection{\texorpdfstring{transform that creates newline-\/delimited JSON}{transform that creates newline-\/delimited JSON}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16956}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16957}{}\doxysubsection{\texorpdfstring{transform that parses newline-\/delimited JSON}{transform that parses newline-\/delimited JSON}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2minipass_2_r_e_a_d_m_e_autotoc_md16957}
