...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e}\index{ipaddr.js — an IPv6 and IPv4 address manipulation library $<$a href="{}https://travis-\/ci.org/whitequark/ipaddr.js"{} $>$$<$img src="{}https://travis-\/ci.org/whitequark/ipaddr.js.svg"{} alt="{}Build Status"{}/$>$$<$/a$>$@{ipaddr.js — an IPv6 and IPv4 address manipulation library $<$a href=""https://travis-\/ci.org/whitequark/ipaddr.js"" $>$$<$img src=""https://travis-\/ci.org/whitequark/ipaddr.js.svg"" alt=""Build Status""/$>$$<$/a$>$}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19939}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19939}%
...
ipaddr.\+js allows you to verify and parse string representation of an IP address, match it against a CIDR range or range list, determine if it falls into some reserved ranges (examples include loopback and private ranges), and convert between IPv4 and IPv4-\/mapped IPv6 addresses.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19940}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19940}
{\ttfamily npm install ipaddr.\+js}

or

{\ttfamily bower install ipaddr.\+js}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19941}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19941}
...
The API consists of several global methods and two classes\+: ipaddr.\+IPv6 and ipaddr.\+IPv4.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19942}{}\doxysubsection{\texorpdfstring{Global methods}{Global methods}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19942}
...
The {\ttfamily ipaddr.\+process} method works just like the {\ttfamily ipaddr.\+parse} one, but it automatically converts IPv4-\/mapped IPv6 addresses to their IPv4 counterparts before returning. It is useful when you have a Node.\+js instance listening on an IPv6 socket, and the {\ttfamily net.\+ivp6.\+bindv6only} sysctl parameter (or its equivalent on non-\/\+Linux OS) is set to 0. In this case, you can accept IPv4 connections on your IPv6-\/only socket, but the remote address will be mangled. Use {\ttfamily ipaddr.\+process} method to automatically demangle it.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19943}{}\doxysubsection{\texorpdfstring{Object representation}{Object representation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19943}
Parsing methods return an object which descends from {\ttfamily ipaddr.\+IPv6} or {\ttfamily ipaddr.\+IPv4}. These objects share some properties, but most of them differ.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19944}{}\doxysubsubsection{\texorpdfstring{Shared properties}{Shared properties}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19944}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19946}{}\doxysubsubsection{\texorpdfstring{IPv4 properties}{IPv4 properties}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19946}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19947}{}\doxysubsubsection{\texorpdfstring{Conversion}{Conversion}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2proxy-addr_2node__modules_2ipaddr_8js_2_r_e_a_d_m_e_autotoc_md19947}
