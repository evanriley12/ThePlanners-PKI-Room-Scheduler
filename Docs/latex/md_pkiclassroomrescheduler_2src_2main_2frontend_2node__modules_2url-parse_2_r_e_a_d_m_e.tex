\chapter{url-\/parse}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e}\index{url-\/parse@{url-\/parse}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26185}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26185}%
...
\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}{\ttfamily url-\/parse} was created in 2014 when the WHATWG URL API was not available in Node.\+js and the {\ttfamily URL} interface was supported only in some browsers. Today this is no longer true. The {\ttfamily URL} interface is available in all supported Node.\+js release lines and basically all browsers. Consider using it for better security and accuracy.\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}
...
In addition to URL parsing we also expose the bundled {\ttfamily querystringify} module.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26186}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26186}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26187}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26187}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26188}{}\doxysubsection{\texorpdfstring{Url.\+set(key, value)}{Url.\+set(key, value)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26188}
...
It\textquotesingle{}s aware of default ports so you cannot set a port 80 on an URL which has {\ttfamily http} as protocol.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26189}{}\doxysubsection{\texorpdfstring{Url.\+to\+String()}{Url.\+to\+String()}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26189}
...
You would rarely need to use this method as the full URL is also available as {\ttfamily href} property. If you are using the {\ttfamily URL.\+set} method to make changes, this will automatically update.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26190}{}\doxysection{\texorpdfstring{Testing}{Testing}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26190}
...
\end{DoxyEnumerate}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26191}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2url-parse_2_r_e_a_d_m_e_autotoc_md26191}
