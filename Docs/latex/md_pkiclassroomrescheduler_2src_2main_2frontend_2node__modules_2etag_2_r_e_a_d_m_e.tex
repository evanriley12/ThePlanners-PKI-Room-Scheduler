\chapter{etag}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e}\index{etag@{etag}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11446}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11446}%
...
This module generates HTTP ETags (as defined in RFC 7232) for use in HTTP responses.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11447}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11447}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11448}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11448}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ etag\ =\ require('etag')}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11449}{}\doxysubsection{\texorpdfstring{etag(entity, \mbox{[}options\mbox{]})}{etag(entity, \mbox{[}options\mbox{]})}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11449}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11450}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11450}
{\ttfamily etag} accepts these properties in the options object.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11451}{}\doxyparagraph{\texorpdfstring{weak}{weak}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11451}
Specifies if the generated ETag will include the weak validator mark (that is, the leading {\ttfamily W/}). The actual entity tag is the same. The default value is {\ttfamily false}, unless the {\ttfamily entity} is {\ttfamily fs.\+Stats}, in which case it is {\ttfamily true}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11452}{}\doxysection{\texorpdfstring{Testing}{Testing}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11452}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11453}{}\doxysection{\texorpdfstring{Benchmark}{Benchmark}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11453}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11454}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2etag_2_r_e_a_d_m_e_autotoc_md11454}
