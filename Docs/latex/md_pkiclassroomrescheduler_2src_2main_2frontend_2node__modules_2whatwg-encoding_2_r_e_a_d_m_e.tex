...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-encoding_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-encoding_2_r_e_a_d_m_e}\index{Decode According to the WHATWG Encoding Standard@{Decode According to the WHATWG Encoding Standard}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-encoding_2_r_e_a_d_m_e_autotoc_md26874}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-encoding_2_r_e_a_d_m_e_autotoc_md26874}%
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-encoding_2_r_e_a_d_m_e_autotoc_md26875}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-encoding_2_r_e_a_d_m_e_autotoc_md26875}
...
\item {\ttfamily get\+BOMEncoding(buffer)}\+: sniffs the first 2–3 bytes of the supplied {\ttfamily Buffer}, returning one of the encoding names {\ttfamily "{}\+UTF-\/8"{}}, {\ttfamily "{}\+UTF-\/16\+LE"{}}, or {\ttfamily "{}\+UTF-\/16\+BE"{}} if the appropriate BOM is present, or {\ttfamily null} if no BOM is present
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-encoding_2_r_e_a_d_m_e_autotoc_md26876}{}\doxysection{\texorpdfstring{Unsupported encodings}{Unsupported encodings}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-encoding_2_r_e_a_d_m_e_autotoc_md26876}
...
Passing these encoding names will return {\ttfamily false} when calling {\ttfamily is\+Supported}, and passing any of the possible labels for these encodings to {\ttfamily label\+To\+Name} will return {\ttfamily null}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-encoding_2_r_e_a_d_m_e_autotoc_md26877}{}\doxysection{\texorpdfstring{Credits}{Credits}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-encoding_2_r_e_a_d_m_e_autotoc_md26877}
This package was originally based on the excellent work of \href{https://github.com/nicolashenry}{\texttt{ @nicolashenry}}, \href{https://github.com/tmpvar/jsdom/blob/7ce11776ce161e8d5921a7a183585327400f786b/lib/jsdom/living/helpers/encoding.js}{\texttt{ in jsdom}}. It has since been pulled out into this separate package.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-encoding_2_r_e_a_d_m_e_autotoc_md26878}{}\doxysection{\texorpdfstring{Alternatives}{Alternatives}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-encoding_2_r_e_a_d_m_e_autotoc_md26878}
