\chapter{Arg}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e}\index{Arg@{Arg}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5114}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5114}%
 {\ttfamily arg} is an unopinionated, no-\/frills CLI argument parser.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5115}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5115}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ install\ arg}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5116}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5116}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5117}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5117}
If a second parameter is specified and is an object, it specifies parsing options to modify the behavior of {\ttfamily arg()}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5118}{}\doxysubsubsection{\texorpdfstring{{\ttfamily argv}}{{\ttfamily argv}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5118}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5119}{}\doxysubsubsection{\texorpdfstring{{\ttfamily permissive}}{{\ttfamily permissive}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5119}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5120}{}\doxysubsubsection{\texorpdfstring{{\ttfamily stop\+At\+Positional}}{{\ttfamily stop\+At\+Positional}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5120}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5121}{}\doxysubsection{\texorpdfstring{Errors}{Errors}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5121}
Some errors that {\ttfamily arg} throws provide a {\ttfamily .code} property in order to aid in recovering from user error, or to differentiate between user error and developer error (bug).\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5122}{}\doxyparagraph{\texorpdfstring{ARG\+\_\+\+UNKNOWN\+\_\+\+OPTION}{ARG\+\_\+\+UNKNOWN\+\_\+\+OPTION}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5122}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5123}{}\doxysection{\texorpdfstring{FAQ}{FAQ}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5123}
A few questions and answers that have been asked before\+:\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5124}{}\doxysubsubsection{\texorpdfstring{How do I require an argument with {\ttfamily arg}?}{How do I require an argument with {\ttfamily arg}?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5124}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5125}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_r_e_a_d_m_e_autotoc_md5125}
Released under the \doxysectlink{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2arg_2_l_i_c_e_n_s_e}{MIT License}{0}. 