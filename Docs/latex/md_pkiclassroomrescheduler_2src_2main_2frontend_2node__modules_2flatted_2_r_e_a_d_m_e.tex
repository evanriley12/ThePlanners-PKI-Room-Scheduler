\chapter{flatted}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e}\index{flatted@{flatted}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12587}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12587}%
...
\DoxyHorRuler{0}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12588}{}\doxysection{\texorpdfstring{Announcement 📣}{Announcement 📣}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12588}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12589}{}\doxysection{\texorpdfstring{to\+JSON and from\+JSON}{to\+JSON and from\+JSON}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12589}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12590}{}\doxysection{\texorpdfstring{Flatted VS JSON}{Flatted VS JSON}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12590}
...
Also please note this project serializes and deserializes only data compatible with JSON, so that sockets, or anything else with internal classes different from those allowed by JSON standard, won\textquotesingle{}t be serialized and unserialized as expected.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12591}{}\doxysubsection{\texorpdfstring{New in V1\+: Exact same JSON API}{New in V1\+: Exact same JSON API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12591}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12592}{}\doxysubsection{\texorpdfstring{Compatibility}{Compatibility}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12592}
All ECMAScript engines compatible with {\ttfamily Map}, {\ttfamily Set}, {\ttfamily Object.\+keys}, and {\ttfamily Array.\+prototype.\+reduce} will work, even if polyfilled.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12593}{}\doxysubsection{\texorpdfstring{How does it work ?}{How does it work ?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2flatted_2_r_e_a_d_m_e_autotoc_md12593}
