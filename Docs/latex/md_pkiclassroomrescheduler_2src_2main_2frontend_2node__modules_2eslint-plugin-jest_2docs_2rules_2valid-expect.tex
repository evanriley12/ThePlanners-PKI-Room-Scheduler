...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect}\index{Enforce valid $<$tt$>$expect()$<$/tt$>$ usage ($<$tt$>$valid-\/expect$<$/tt$>$)@{Enforce valid $<$tt$>$expect()$<$/tt$>$ usage ($<$tt$>$valid-\/expect$<$/tt$>$)}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10499}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10499}%
 Ensure {\ttfamily expect()} is called with a single argument and there is an actual expectation made.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10500}{}\doxysection{\texorpdfstring{Rule details}{Rule details}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10500}
...
This rule is enabled by default.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10501}{}\doxysection{\texorpdfstring{Options}{Options}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10501}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10502}{}\doxysubsection{\texorpdfstring{{\ttfamily always\+Await}}{{\ttfamily always\+Await}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10502}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10503}{}\doxysubsection{\texorpdfstring{{\ttfamily async\+Matchers}}{{\ttfamily async\+Matchers}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10503}
...
By default, this has a list of all the async matchers provided by {\ttfamily jest-\/extended} (namely, {\ttfamily to\+Resolve} and {\ttfamily to\+Reject}).\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10504}{}\doxysubsection{\texorpdfstring{{\ttfamily min\+Args} \& {\ttfamily max\+Args}}{{\ttfamily min\+Args} \& {\ttfamily max\+Args}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10504}
...
This is useful when you\textquotesingle{}re using libraries that increase the number of arguments supported by {\ttfamily expect}, such as \href{https://www.npmjs.com/package/jest-expect-message}{\texttt{ {\ttfamily jest-\/expect-\/message}}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10505}{}\doxysubsection{\texorpdfstring{Default configuration}{Default configuration}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2valid-expect_autotoc_md10505}
