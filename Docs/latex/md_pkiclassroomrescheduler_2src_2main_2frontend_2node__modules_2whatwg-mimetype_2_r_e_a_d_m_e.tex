\chapter{Parse, serialize, and manipulate MIME types}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e}\index{Parse, serialize, and manipulate MIME types@{Parse, serialize, and manipulate MIME types}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26899}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26899}%
...
This package\textquotesingle{}s algorithms conform to those of the WHATWG \href{https://mimesniff.spec.whatwg.org/}{\texttt{ MIME Sniffing Standard}}, and is aligned up to commit \href{https://github.com/whatwg/mimesniff/commit/126286ab2dcf3e2d541349ed93539a88bf394ad5}{\texttt{ 126286a}}.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26900}{}\doxysection{\texorpdfstring{{\ttfamily MIMEType} API}{{\ttfamily MIMEType} API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26900}
This package\textquotesingle{}s main module\textquotesingle{}s default export is a class, {\ttfamily MIMEType}. Its constructor takes a string which it will attempt to parse into a MIME type; if parsing fails, an {\ttfamily Error} will be thrown.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26901}{}\doxysubsection{\texorpdfstring{The {\ttfamily parse()} static factory method}{The {\ttfamily parse()} static factory method}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26901}
As an alternative to the constructor, you can use {\ttfamily MIMEType.\+parse(string)}. The only difference is that {\ttfamily parse()} will return {\ttfamily null} on failed parsing, whereas the constructor will throw. It thus makes the most sense to use the constructor in cases where unparseable MIME types would be exceptional, and use {\ttfamily parse()} when dealing with input from some unconstrained source.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26902}{}\doxysubsection{\texorpdfstring{Properties}{Properties}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26902}
...
{\ttfamily parameters} is also a getter, but the contents of the {\ttfamily MIMEType\+Parameters} object are mutable, as described below.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26903}{}\doxysubsection{\texorpdfstring{Methods}{Methods}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26903}
...
\item {\ttfamily is\+Java\+Script(\{ allow\+Parameters \})}\+: returns true if this instance represents \href{https://html.spec.whatwg.org/multipage/scripting.html\#javascript-mime-type}{\texttt{ a Java\+Script MIME type}}; {\ttfamily allow\+Parameters} can be set to true to allow arbitrary parameters, instead of their presence causing the method to return {\ttfamily false}
\end{DoxyItemize}

{\itshape Note\+: the {\ttfamily is\+HTML()}, {\ttfamily is\+XML()}, and {\ttfamily is\+Java\+Script()} methods are speculative, and may be removed or changed in future major versions. See \href{https://github.com/whatwg/mimesniff/issues/48}{\texttt{ whatwg/mimesniff\#48}} for brainstorming in this area. Currently we implement these mainly because they are useful in jsdom.}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26904}{}\doxysection{\texorpdfstring{{\ttfamily MIMEType\+Parameters} API}{{\ttfamily MIMEType\+Parameters} API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26904}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26905}{}\doxysection{\texorpdfstring{Raw parsing/serialization APIs}{Raw parsing/serialization APIs}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2whatwg-mimetype_2_r_e_a_d_m_e_autotoc_md26905}
