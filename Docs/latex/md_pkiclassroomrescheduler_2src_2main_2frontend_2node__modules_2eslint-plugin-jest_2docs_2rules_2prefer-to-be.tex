...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2prefer-to-be}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2prefer-to-be}\index{Suggest using $<$tt$>$toBe()$<$/tt$>$ for primitive literals ($<$tt$>$prefer-\/to-\/be$<$/tt$>$)@{Suggest using $<$tt$>$toBe()$<$/tt$>$ for primitive literals ($<$tt$>$prefer-\/to-\/be$<$/tt$>$)}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2prefer-to-be_autotoc_md10471}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2prefer-to-be_autotoc_md10471}%
...
This rule recommends using the {\ttfamily to\+Be} matcher in these situations, as it forms the most grammatically natural sentence. For {\ttfamily null}, {\ttfamily undefined}, and {\ttfamily NaN} this rule recommends using their specific {\ttfamily to\+Be} matchers, as they give better error messages as well.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2prefer-to-be_autotoc_md10472}{}\doxysection{\texorpdfstring{Rule details}{Rule details}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2eslint-plugin-jest_2docs_2rules_2prefer-to-be_autotoc_md10472}
