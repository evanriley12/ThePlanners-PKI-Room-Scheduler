...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme}\index{resolve.exports $<$a href="{}https://github.com/lukeed/resolve.exports/actions"{} $>$$<$img src="{}https://github.com/lukeed/resolve.exports/workflows/CI/badge.svg"{} alt="{}CI"{}/$>$$<$/a$>$ $<$a href="{}https://codecov.io/gh/lukeed/resolve.exports"{} $>$$<$img src="{}https://codecov.io/gh/lukeed/resolve.exports/branch/master/graph/badge.svg?token=4P7d4Omw2h"{} alt="{}codecov"{}/$>$$<$/a$>$@{resolve.exports $<$a href=""https://github.com/lukeed/resolve.exports/actions"" $>$$<$img src=""https://github.com/lukeed/resolve.exports/workflows/CI/badge.svg"" alt=""CI""/$>$$<$/a$>$ $<$a href=""https://codecov.io/gh/lukeed/resolve.exports"" $>$$<$img src=""https://codecov.io/gh/lukeed/resolve.exports/branch/master/graph/badge.svg?token=4P7d4Omw2h"" alt=""codecov""/$>$$<$/a$>$}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20679}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20679}%
 \begin{quote}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20680}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20680}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ resolve.exports}

\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20681}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20681}
\begin{quote}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20682}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20682}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20683}{}\doxysubsection{\texorpdfstring{resolve(pkg, entry?, options?)}{resolve(pkg, entry?, options?)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20683}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20684}{}\doxysubsubsection{\texorpdfstring{pkg}{pkg}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20684}
Type\+: {\ttfamily object} ~\newline
 Required\+: {\ttfamily true}

The {\ttfamily package.\+json} contents.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20685}{}\doxysubsubsection{\texorpdfstring{entry}{entry}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20685}
Type\+: {\ttfamily string} ~\newline
...
\end{longtabu}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20686}{}\doxysubsubsection{\texorpdfstring{options.\+require}{options.\+require}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20686}
Type\+: {\ttfamily boolean} ~\newline
 Default\+: {\ttfamily false}

When truthy, the {\ttfamily "{}require"{}} field is added to the list of allowed/known conditions.

When falsey, the {\ttfamily "{}import"{}} field is added to the list of allowed/known conditions instead.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20687}{}\doxysubsubsection{\texorpdfstring{options.\+browser}{options.\+browser}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20687}
Type\+: {\ttfamily boolean} ~\newline
 Default\+: {\ttfamily false}

When truthy, the {\ttfamily "{}browser"{}} field is added to the list of allowed/known conditions.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20688}{}\doxysubsubsection{\texorpdfstring{options.\+conditions}{options.\+conditions}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20688}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20689}{}\doxysubsubsection{\texorpdfstring{options.\+unsafe}{options.\+unsafe}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20689}
Type\+: {\ttfamily boolean} ~\newline
 Default\+: {\ttfamily false}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20690}{}\doxysubsection{\texorpdfstring{legacy(pkg, options?)}{legacy(pkg, options?)}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20690}
Returns\+: {\ttfamily string} or {\ttfamily undefined}
...
When a field is found, its value is returned {\itshape as written}. ~\newline
 When no fields were found, {\ttfamily undefined} is returned. If you wish to mimic Node.\+js behavior, you can assume this means `\textquotesingle{}index.\+js'\`{} – but this module does not make that assumption for you.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20691}{}\doxysubsubsection{\texorpdfstring{options.\+browser}{options.\+browser}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20691}
...
\end{quote}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20692}{}\doxysubsubsection{\texorpdfstring{options.\+fields}{options.\+fields}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20692}
Type\+: {\ttfamily string\mbox{[}\mbox{]}} ~\newline
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20693}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2resolve_8exports_2readme_autotoc_md20693}
