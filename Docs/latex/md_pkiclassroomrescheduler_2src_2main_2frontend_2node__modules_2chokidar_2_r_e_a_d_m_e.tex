...
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e}\index{Chokidar $<$a href="{}https://github.com/paulmillr/chokidar"{} $>$$<$img src="{}https://img.shields.io/npm/dw/chokidar.svg"{} alt="{}Weekly downloads"{}/$>$$<$/a$>$ $<$a href="{}https://github.com/paulmillr/chokidar"{} $>$$<$img src="{}https://img.shields.io/npm/dy/chokidar.svg"{} alt="{}Yearly downloads"{}/$>$$<$/a$>$@{Chokidar $<$a href=""https://github.com/paulmillr/chokidar"" $>$$<$img src=""https://img.shields.io/npm/dw/chokidar.svg"" alt=""Weekly downloads""/$>$$<$/a$>$ $<$a href=""https://github.com/paulmillr/chokidar"" $>$$<$img src=""https://img.shields.io/npm/dy/chokidar.svg"" alt=""Yearly downloads""/$>$$<$/a$>$}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6610}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6610}%
 \begin{quote}
Minimal and efficient cross-\/platform file watching library \end{quote}
\href{https://www.npmjs.com/package/chokidar}{\texttt{ }}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6611}{}\doxysection{\texorpdfstring{Why?}{Why?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6611}
...
Version 3 is out! Check out our blog post about it\+: \href{https://paulmillr.com/posts/chokidar-3-save-32tb-of-traffic/}{\texttt{ Chokidar 3\+: How to save 32TB of traffic every week}}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6612}{}\doxysection{\texorpdfstring{How?}{How?}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6612}
...
On most other platforms, the {\ttfamily fs.\+watch}-\/based implementation is the default, which avoids polling and keeps CPU usage down. Be advised that chokidar will initiate watchers recursively for everything within scope of the paths that have been specified, so be judicious about not wasting system resources by watching much more than needed.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6613}{}\doxysection{\texorpdfstring{Getting started}{Getting started}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6613}
Install with npm\+:
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6614}{}\doxysection{\texorpdfstring{API}{API}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6614}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6615}{}\doxysubsubsection{\texorpdfstring{Persistence}{Persistence}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6615}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6616}{}\doxysubsubsection{\texorpdfstring{Path filtering}{Path filtering}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6616}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6617}{}\doxysubsubsection{\texorpdfstring{Performance}{Performance}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6617}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6618}{}\doxysubsubsection{\texorpdfstring{Errors}{Errors}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6618}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6619}{}\doxysubsection{\texorpdfstring{Methods \& Events}{Methods \& Events}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6619}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6620}{}\doxysection{\texorpdfstring{CLI}{CLI}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6620}
If you need a CLI interface for your file watching, check out \href{https://github.com/open-cli-tools/chokidar-cli}{\texttt{ chokidar-\/cli}}, allowing you to execute a command on each change, or get a stdio stream of change events.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6621}{}\doxysection{\texorpdfstring{Install Troubleshooting}{Install Troubleshooting}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6621}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6622}{}\doxysection{\texorpdfstring{Changelog}{Changelog}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6622}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6623}{}\doxysection{\texorpdfstring{Also}{Also}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6623}
Why was chokidar named this way? What\textquotesingle{}s the meaning behind it?

\texorpdfstring{$>$}{>}Chowkidar is a transliteration of a Hindi word meaning \textquotesingle{}watchman, gatekeeper\textquotesingle{}, चौकीदार. This ultimately comes from Sanskrit \+\_\+ चतुष्क\+\_\+ (crossway, quadrangle, consisting-\/of-\/four). This word is also used in other languages like Urdu as (چوکیدار) which is widely used in Pakistan and India.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6624}{}\doxysection{\texorpdfstring{License}{License}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2chokidar_2_r_e_a_d_m_e_autotoc_md6624}
