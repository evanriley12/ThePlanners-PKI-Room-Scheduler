\chapter{saxes}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e}{}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e}\index{saxes@{saxes}}
\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22550}%
\Hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22550}%
...
Saxes does not support Node versions older than 10.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22551}{}\doxysection{\texorpdfstring{Notable Differences from Sax.}{Notable Differences from Sax.}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22551}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22552}{}\doxysection{\texorpdfstring{Conformance}{Conformance}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22552}
Saxes supports\+:
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22553}{}\doxysection{\texorpdfstring{Limitations}{Limitations}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22553}
This is a non-\/validating parser so it only verifies whether the document is well-\/formed. We do aim to raise errors for all malformed constructs encountered. However, this parser does not thorougly parse the contents of DTDs. So most malformedness errors caused by errors {\bfseries{in DTDs}} cannot be reported.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22554}{}\doxysection{\texorpdfstring{Regarding {\ttfamily \texorpdfstring{$<$}{<}!\+DOCTYPE} and {\ttfamily \texorpdfstring{$<$}{<}!\+ENTITY}}{Regarding {\ttfamily \texorpdfstring{$<$}{<}!\+DOCTYPE} and {\ttfamily \texorpdfstring{$<$}{<}!\+ENTITY}}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22554}
The parser will handle the basic XML entities in text nodes and attribute values\+: {\ttfamily \&amp; \&lt; \&gt; \&apos; \&quot;}. It\textquotesingle{}s possible to define additional entities in XML by putting them in the DTD. This parser doesn\textquotesingle{}t do anything with that. If you want to listen to the {\ttfamily doctype} event, and then fetch the doctypes, and read the entities and add them to {\ttfamily parser.\+ENTITIES}, then be my guest.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22555}{}\doxysection{\texorpdfstring{Documentation}{Documentation}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22555}
...
If there\textquotesingle{}s a mistake in the documentation, raise an issue. If you just assume, you may assume incorrectly.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22556}{}\doxysection{\texorpdfstring{Summary Usage Information}{Summary Usage Information}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22556}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22557}{}\doxysubsection{\texorpdfstring{Example}{Example}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22557}
...
\end{DoxyCode}
\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22558}{}\doxysubsection{\texorpdfstring{Constructor Arguments}{Constructor Arguments}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22558}
Settings supported\+:
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22559}{}\doxysubsection{\texorpdfstring{Methods}{Methods}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22559}
...
{\ttfamily close} -\/ Close the stream. Once closed, no more data may be written until it is done processing the buffer, which is signaled by the {\ttfamily end} event.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22560}{}\doxysubsection{\texorpdfstring{Properties}{Properties}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22560}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22562}{}\doxysubsection{\texorpdfstring{Events}{Events}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22562}
...
See the JSDOC comments in the source code for a description of each supported event.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22563}{}\doxysubsection{\texorpdfstring{Parsing XML Fragments}{Parsing XML Fragments}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22563}
...
Of course, {\ttfamily additional\+Namespaces} and {\ttfamily resolve\+Prefix} are used only if {\ttfamily xmlns} is {\ttfamily true}. If you are parsing a fragment that does not use namespaces, there\textquotesingle{}s no point in setting these options.\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22564}{}\doxysubsection{\texorpdfstring{Performance Tips}{Performance Tips}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22564}
...
\end{DoxyItemize}\hypertarget{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22565}{}\doxysection{\texorpdfstring{FAQ}{FAQ}}\label{md_pkiclassroomrescheduler_2src_2main_2frontend_2node__modules_2saxes_2_r_e_a_d_m_e_autotoc_md22565}
